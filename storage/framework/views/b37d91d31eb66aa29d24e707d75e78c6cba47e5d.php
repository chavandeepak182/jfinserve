      ...
      <div class="container">
        <div class="row align-items-center justify-content-around text-center text-lg-left">
          ...
          <div class="col-md-9 col-lg-6 col-xl-5 order-lg-1" data-aos="fade-left">
            <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/term.jpg" alt="Image" class="img-fluid term-fluid rounded shadow">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-around text-center text-lg-left">
          ...
          <div class="col-md-9 col-lg-6 col-xl-5 order-lg-2" data-aos="fade-left">
            <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/term1.jpg" alt="Image" class="img-fluid rounded shadow">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-around text-center text-lg-left ">
         <div class="col-md-9 col-lg-6 col-xl-5" data-aos="fade-in" data-aos-offset="250">
          <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/term3.jpg" alt="Image" class="img-fluid rounded shadow">
        </div>
            ...
            <div class="mb-3 mr-4 ml-lg-0 mr-lg-4" data-aos="fade-left" data-aos-delay="100">
              <div class="d-flex align-items-center">
                <div class="rounded-circle bg-success-alt">
                  <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/icons/interface/icon-check.svg" alt="Binoculars icon" class="m-2 icon icon-xs bg-success" data-inject-svg="">
                </div>
...
<section>
  <div class="container">
    <div class="row align-items-center justify-content-around text-center text-lg-left">
      ...
      <div class="col-md-9 col-lg-6 col-xl-5 order-lg-2" data-aos="fade-left">
        <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/term7.png" alt="Image" class="img-fluid rounded shadow">
...
<!-- <section class="pt-20">
  <div class="container">
    ...
    <div class="col-md-9 col-lg-6 col-xl-5 order-lg-1" data-aos="fade-in">
      <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/term9.jpg" alt="Image" class="img-fluid rounded shadow">
        ...
        <div class="col col-md-10">
          ...
          <div class="row">
            <div class="card card-body shadow text-left text-dark">
              <form method="post" action="<?php echo e(config('app.baseURL')); ?>/insurance/term-insurance" enctype='multipart/form-data'>
                   <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/insurance/term-insurance.blade.php ENDPATH**/ ?>