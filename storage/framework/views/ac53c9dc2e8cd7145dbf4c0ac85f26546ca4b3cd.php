...
<?php $__env->startSection('keywords', 'rate of interest hdfc bank, hdfc bank personal, interest rate icici bank, hdfc customer care home loan, sbi interest rates for car loan, personal loan interest in sbi, sbi home loans interest rates, axis mutual funds login, hdfc equity funds, axis long term equity growth fund, sip calculator'); ?>
<?php $__env->startSection('description', 'Simplified Loans & Investments. Get money when you need it with our loan products. Invest in Top Performing Equity Funds.'); ?>
...
<div class="bg-primary-3 o-hidden breadcum-header" data-overlay="">
  <section class="text-white section-padding">
    ...
    <section class="bg-light section-padding">
      <div class="container">
       <center><img src="<?php echo e(asset('assets\img\very-happy.jpg')); ?>" alt="FinKompas" class="img-fluid contact-width"></center>
       <div class="row">
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-md-11 col-lg-10 col-xl-9">
          <form action="<?php echo e(config('app.baseURL')); ?>/get-started" method="post">
             ...
             <div class="col-sm">
              <div class="form-group">
                ...
                <div class="position-relative">
                  ...
                  <img src="<?php echo e(asset('assets\img\icons\interface\icon-caret-down.svg')); ?>" alt="Arrow Down" class="icon icon-sm">
                  <div class="invalid-feedback">
...
<?php echo $__env->make('layouts.app', ['title' => 'Simplifying Your Financial Life. No Fees. Low Rates. Great Benefits. Apply for loan in 30 seconds. Get instant quote for Top Performing Equity Funds'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/get-started.blade.php ENDPATH**/ ?>