                          ...
                          <div class="content-header row">
                            <div class="content-header-left col-md-9 col-12 mb-2">
                              <div class="row breadcrumbs-top">
                                <div class="col-12">
                                  <h2 class="content-header-title float-left mb-0">Rejected Loan</h2>
                                  <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item">
                                        <a href="<?php echo e(config('app.baseURL')); ?>/myloanreject/<?php echo e($user_id); ?>"> Rejected Loan </a>
                                      </li>
                                      <li class="breadcrumb-item">
                                      All                                </li>
                                    </ol> 
                        ...
                        <script>
                          $(function(){
                            $("#footer-table").DataTable({
                              ...
                              "paging": true,
                              "order": [[ 1, "desc" ]],
                              "ajax": "<?php echo e(config('app.baseURL')); ?>/myloanreject/all/<?php echo e($user_id); ?>",
...
<?php echo $__env->make('layouts.user-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u540016792/domains/jfinserv.com/public_html/resources/views/myaccount/myrejected_loan.blade.php ENDPATH**/ ?>