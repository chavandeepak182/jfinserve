...
<?php $__env->startSection('title', "Financial Services in Pune | Business loan services in Pune - Jfinserv"); ?>
<?php $__env->startSection('description', "Discover tailored home loan solutions and comprehensive financial services in Pune. Our expert team is business loan services in Pune."); ?>
<?php $__env->startSection('keywords', "financial services in pune, Home loan services in Pune, business loan provider in pune, Business loan services in Pune, Business loan in Pune"); ?>
...
<main>
                        ...
                        <div class="row gy-4 gy-lg-0 gx-5">
                            ...
                            <div class="col-lg-4">
                                <div class="steps-widget pr-30 pl-30 wow fadeInUp" data-wow-delay="0.5s">
                                    ...
                                    <h4><a>Earning Oppurtunities</a></h4>
    ...
    <section class="backbg pt-200 pb-80  bg-white" >
        <div class="container backbg">
            <div class="row section-title justify-content-center text-center">
                <div class="col-md-9 col-lg-8 col-xl-7 box-height">
                    <h3 class="display-8 text-top" style="padding-bottom: 35px;"><span style="color: #0050b2;">JFINSERV </span>Can Help With All Your<br/>Lending Needs</h3>
            ...
            <div class="row box">
                <div class="col-md-6 col-lg-4 mb-3 mb-md-4 d-flex">
                    <div class="card hover-box-shadow">
                        <a href="<?php echo e(config('app.baseURL')); ?>/home-loan" class="d-block rounded-top">
                            <img class="card-img-top hover-fade-out img-img" src="<?php echo e(config('app.baseURL')); ?>/images/house.jpg" alt="Edutech chatbot">
                        </a>
                        <div class="card-body">
                             <a href="<?php echo e(config('app.baseURL')); ?>/home-loan"> 
                                <h3 style="font-size: 18px !important;font-weight: 700;">Home Loan</h3>
                                <p style="font-size: 14px !important;">At JFINSERV, we understand you don’t really want a loan, but a new home or to save money on your repayments. We’re here to help with low rates, great features, and a seamless process to settlement. We acknowledge that buying a home is one of life's most significant financial decisions. <br/></p>
                                <a href="<?php echo e(config('app.baseURL')); ?>/home-loan" class="theme-btn mt-3">Apply Now <i class="arrow_right"></i></a>
                             </a> 
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-3 mb-md-4 d-flex">
                    <div class="card hover-box-shadow">
                        <a href="<?php echo e(config('app.baseURL')); ?>/contract-loan" class="d-block rounded-top">
                            <img class="card-img-top hover-fade-out img-img" src="<?php echo e(config('app.baseURL')); ?>/images/mortage.jpg" alt="Edutech chatbot">
                        </a>
                        <div class="card-body">
                            <a href="<?php echo e(config('app.baseURL')); ?>/contract-loan"> 
                                <h3 style="font-size: 18px !important;font-weight: 700;">Contract Loan</h3>
                                <p style="font-size: 14px !important;">JFINSERV brings to you - Contract Loan - an innovative combination of a loan and overdraft facility with flexible repayment options against the security of your immovable property. Check out your loan against property eligibility and get exclusive add on benefits and tax benefits.<br/></p>
                                <a href="<?php echo e(config('app.baseURL')); ?>/contract-loan" class="theme-btn mt-3">Apply Now <i class="arrow_right"></i></a>
                            </a> 
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-3 mb-md-4 d-flex">
                    <div class="card hover-box-shadow">
                        <a href="<?php echo e(config('app.baseURL')); ?>/project-loan" class="d-block rounded-top">
                            <img class="card-img-top hover-fade-out img-img" src="<?php echo e(config('app.baseURL')); ?>/images/project-loan.jpg" alt="Edutech chatbot">
                        </a>
                        <div class="card-body">
                            <a href="<?php echo e(config('app.baseURL')); ?>/project-loan">
                                <h3 style="font-size: 18px !important;font-weight: 700;">Project Loan</h3>
                                <p style="font-size: 14px !important;">We'll help take the stress out of financing your building or renovation with our low rates and easy online application. From streamlined packages to fully-featured loans, you'll find the low rate construction loan that's perfect for you and that's executed seamlessly and on time.<br/></p>
                                <a href="<?php echo e(config('app.baseURL')); ?>/project-loan" class="theme-btn mt-3">Apply Now <i class="arrow_right"></i></a>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-3 mb-md-4 d-flex">
                    <div class="card hover-box-shadow">
                        <a href="<?php echo e(config('app.baseURL')); ?>/overdraft-facility" class="d-block rounded-top">
                            <img class="card-img-top hover-fade-out img-img" src="<?php echo e(config('app.baseURL')); ?>/images/od-loan.jpg" alt="Edutech chatbot">
                        </a>
                        <div class="card-body">
                            <a href="<?php echo e(config('app.baseURL')); ?>/overdraft-facility">
                                <h3 style="font-size: 18px !important;font-weight: 700;">Overdraft Facility</h3>
                                <p style="font-size: 14px !important;">An overdraft facility allows you to withdraw funds from a fixed line of credit as and when you need to. Repayment is also easy and hassle-free, as you can repay what you borrow at your convenience. This makes an overdraft facility one of the most desired credit options. JFinserv offers these features through its unsecured Flexi personal loan.<br/></p>
                                <a href="<?php echo e(config('app.baseURL')); ?>/overdraft-facility" class="theme-btn mt-3">Apply Now <i class="arrow_right"></i></a>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-3 mb-md-4 d-flex">
                    <div class="card hover-box-shadow">
                        <a href="<?php echo e(config('app.baseURL')); ?>/lease-rental-discounting" class="d-block rounded-top">
                            <img class="card-img-top hover-fade-out img-img" src="<?php echo e(config('app.baseURL')); ?>/images/capital.jpg" alt="Edutech chatbot">
                        </a>
                        <div class="card-body">
                            <a href="<?php echo e(config('app.baseURL')); ?>/lease-rental-discounting">
                                <h3 style="font-size: 18px !important;font-weight: 700;">Lease Rental Discounting (LRD)</h3>
                                <p style="font-size: 14px !important;">Lease Rental Discounting is a term loan that is offered against rental receipts and is availed by tenants against leased contracts. So, if you want to avail of funding, against your rental receipts, this financing option enables you to do that. LSD involves obtaining a Term Loan against the income generated from commercial assets or properties.<br/></p>
                                <a href="<?php echo e(config('app.baseURL')); ?>/lease-rental-discounting" class="theme-btn mt-3">Apply Now <i class="arrow_right"></i></a>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-3 mb-md-4 d-flex">
                    <div class="card hover-box-shadow">
                        <a href="<?php echo e(config('app.baseURL')); ?>/msme-loan" class="d-block rounded-top">
                            <img class="card-img-top hover-fade-out img-img" src="<?php echo e(config('app.baseURL')); ?>/images/msme-loan.jpg" alt="Edutech chatbot">
                        </a>
                        <div class="card-body">
                            <a href="<?php echo e(config('app.baseURL')); ?>/msme-loan">
                                <h3 style="font-size: 18px !important;font-weight: 700;">MSME Loan</h3>
                                <p style="font-size: 14px !important;">Our MSME Loan offerings are crafted to address the diverse needs of small and medium-sized businesses across various sectors. Whether you're looking to expand operations, invest in new equipment, boost working capital, or pursue any other growth opportunity, Jfinserv is here to help you every step of the way.<br/></p>
                                <a href="<?php echo e(config('app.baseURL')); ?>/msme-loan" class="theme-btn mt-3">Apply Now <i class="arrow_right"></i></a>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-6 mx-auto">
                    <div class="section-title">
                        <h2 class="wow fadeInUp">One Step Closer To Finding Your <span style="color: #0050b2;">Perfect Loan!</span></h2>
                    </div>
                </div>
            </div>
    ...
    <section class="no-gutters bg-white pt-80 pb-80" id="HomeLoanCalculator">
        <div class="container">
            <div class="row pb-5">
                <div class="col-lg-6 mx-auto">
                    <div class="section-title">
                        <h2 class="wow fadeInUp">Loan Calculator</h2>
                        <p class="wow fadeInUp" data-wow-delay="0.3s">Get an approximate figure for the total monthly instalment payments along with a complete break-up of your loan.</p>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/loan/home-loan.blade.php ENDPATH**/ ?>