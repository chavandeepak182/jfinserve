        ...
        <div id="myCarousel" class="carousel slide mb-5" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="<?php echo e(config('app.baseURL')); ?>/images/about2.jpg" alt="happy family" class="banner-area-2 pt-95">
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\public_html\resources\views/index.blade.php ENDPATH**/ ?>