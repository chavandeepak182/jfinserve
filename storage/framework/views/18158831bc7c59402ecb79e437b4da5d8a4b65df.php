<?php $__env->startSection('keywords', 'top mutual funds, top 5 mutual funds, top mutual funds, top 10 Mutual Funds, SIP Calculator, Mutual Fund Calculator, Mutual Funds, Best Investment Plan, Best SIP Plans, SIP Calculator'); ?>
<?php $__env->startSection('description', 'Simplified Investments - Great Options. No Fees. Dream to make it big in life. Our Investment products can help you build a healthy wealth corpus when held over the long term.'); ?>
        ...
        <div class="row justify-content-center">
          <div class="col-md-3 mb-3 mb-md-4" data-aos="fade-up" data-aos-delay="10">
            <div class="card card-body mutual-card-body bg-white min-vh-md-10 hover-box-shadow" id="large-cap">
              <div class="flex-fill">
                <h4 class="h4"><img src="<?php echo e(config('app.baseURL')); ?>/assets/img/urban.png" class="equity_fund">Large Cap</h4>

              </div>
              <a href="<?php echo e(config('app.baseURL')); ?>/investment/equity-funds/large-cap" class="stretched-link"></a>
            </div>
          </div>
          <div class="col-md-3 mb-3 mb-md-4" data-aos="fade-up" data-aos-delay="20">
            <div class="card card-body mutual-card-body bg-white min-vh-md-10 hover-box-shadow" id="mid-cap">
              <div class="flex-fill">
                <h4 class="h4"><img src="<?php echo e(config('app.baseURL')); ?>/assets/img/company.png" class="equity_fund">Mid Cap</h4>

              </div>
              <a href="<?php echo e(config('app.baseURL')); ?>/investment/equity-funds/mid-cap" class="stretched-link"></a>
            </div>
          </div>
          <div class="col-md-3 mb-3 mb-md-4" data-aos="fade-up" data-aos-delay="30">
            <div class="card card-body mutual-card-body bg-white min-vh-md-10 hover-box-shadow" id="focused">
              <div class="flex-fill">
                <h4 class="h4"><img src="<?php echo e(config('app.baseURL')); ?>/assets/img/target.png" class="equity_fund">Focused</h4>

              </div>
              <a href="<?php echo e(config('app.baseURL')); ?>/investment/equity-funds/focused" class="stretched-link"></a>
            </div>
          </div>
          <div class="col-md-3 mb-3 mb-md-4" data-aos="fade-up" data-aos-delay="40">
            <div class="card card-body mutual-card-body bg-white min-vh-md-10 hover-box-shadow" id="elss">
              <div class="flex-fill">
                <h4 class="h4"><img src="<?php echo e(config('app.baseURL')); ?>/assets/img/money_grow.png" class="equity_fund">ELSS</h4>

              </div>
              <a href="<?php echo e(config('app.baseURL')); ?>/investment/equity-funds/elss" class="stretched-link"></a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row justify-content-between align-items-start">
      <div class="col-lg-8">
       ...
       <?php $__currentLoopData = $mutual_fund_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mutual_fund_list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
       <div class="mb-3 mb-sm-4">
        <a href="<?php echo e($mutual_fund_list->mutual_fund_name); ?>" data-toggle="modal" data-target="#modal-a2" class="card card-body mutual-card-body hover-box-shadow mutual_fund_list" id="mutual_fund_list" tabindex="<?php echo e($mutual_fund_list->mutual_fund_list_id); ?>" >
        
          
         <!--  <p>Maecenas vestibulum sed erat eget blandit.</p> -->
          <div class="align-items-center">
             <span class="rating-num rating-5" style="float: right;"><?php echo e($mutual_fund_list->rating); ?></span>
             <h6><?php echo e($mutual_fund_list->mutual_fund_name); ?></h6>
              <div class="d-flex mutual-d-flex">
            <img src="<?php echo e(config('app.baseURL')); ?>/storage/app/<?php echo e($mutual_fund_list->logo); ?>" alt="" class="avatar avatar-sm">
            ...
            <div class="text-small ml-5">
              ...
              <div>
                <p>AUM ( Cr )<br><span class="plan"><?php echo e($mutual_fund_list->aum_cr); ?> </span></p>
              </div>
            ...
            <div class="text-small ml-5">
              ...
              <div>
                <p>Return ( 1 Yr )<br><span class="return"> <?php echo e($mutual_fund_list->one_year); ?>%</span></p>
              </div>
            ...
            <div class="text-small ml-5">
              ...
              <div>
                <p>Return ( 3 Yr )<br><span class="return"> <?php echo e($mutual_fund_list->three_year); ?>%</span></p>
              </div>
             ...
             <div class="text-small ml-5">
              ...
              <div>
                <p>Return ( 5 Yr )<br><span class="return"> <?php echo e($mutual_fund_list->five_year); ?>%</span></p>
              </div>
            ...
            <div class="modal-body" style="background: #fff;">
              <p style="color:#555555; font-weight:400;font-size: 14px;">Please share your contact details to get an offer</p>
                <div  class="form-section">
                    ...
                    <form class="contact-form"  method="post" action="<?php echo e(config('app.baseURL')); ?>/apply-now" enctype='multipart/form-data'>
                        <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
...
<?php echo $__env->make('layouts.app', ['title' => 'Simplified Investments - Great Options. No Fees. Invest Online in Top Performing Equity Funds'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/investment/equity-funds.blade.php ENDPATH**/ ?>