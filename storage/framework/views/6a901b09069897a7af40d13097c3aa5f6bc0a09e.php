      ...
      <div class="row justify-content-center my-1">
          <div class="col-lg-8 col-md-12">
            ...
            <div class="card card-body shadow text-left text-dark" style="border-radius: 10px;">
              ...
              <form method="POST" action="<?php echo e(config('app.baseURL')); ?>/passwordreset">
                <?php echo csrf_field(); ?>
                <div class="form-group" >
                   <input id="number" type="number" placeholder="Contact Number" class="form-control <?php $__errorArgs = ['contact_number'];
...
unset($__errorArgs, $__bag); ?>" name="contact_number" value="<?php echo e(old('contact_number')); ?>" required autocomplete="contact_number" autofocus>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/auth/passwords/email.blade.php ENDPATH**/ ?>