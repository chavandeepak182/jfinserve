                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="banner-content">
                            ...
                            <a href="<?php echo e(config('app.baseURL')); ?>/apply-now" data-wow-delay="0.5s"
                                class="wow fadeInUp theme-btn theme-btn-lg mt-50">Apply
                                now <i class="material-icons">chevron_right</i>
                            </a>
                        </div>
                    </div>
                    <div class=" col-md-6 col-lg-5 offset-lg-1 pt-40">
                        <div class="banner-img">
                            <img class="main-img img-fluid wow fadeInRight" src="<?php echo e(config('app.baseURL')); ?>/images\home.jpg"
                                alt="banner-img">
                            <div class="shapes">
                        ...
                        <div class="col-xl-3 col-md-6 offset-xl-1 ">
                            <div class="apply-topics">
                                <ul>
                                    ...
                                    <li><i class="fa-solid fa-square-check"></i><b>Unlimited Earning Opportunity Through Referral</b></li>
                                </ul>
                                <a href="<?php echo e(config('app.baseURL')); ?>/apply-now" class="theme-btn mt-20 w-100">Apply For Loan</a>
                            </div>
                        </div>
            ...
            <div class="col-xl-6 mb-5 mb-xl-0" data-aos="fade-right">
                    ...
                    <div class="text-xl-left mb-lg-2">
                       <!-- <span  class="tag-color">ABOUT US</span> -->
                        <div class="section-title text-start">
                                <h2 class="mb-3">Unique Reward and Earning Opportunity with <span style="color: #0050b2;">JFINSERV</span></h2>
                                <!-- <p>Need some fast cash? Bad cradit history? We dont mind about your past,
                                    just the
                                    future.
                                    Try loan start and feel secure in your future.</p> -->
                        ...
                        <div class="faq-widget">
                            <div class="accordion" id="accordionExample">
                                <div class="single-widget-one wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="w-100">
                                        <div class="faq-header" id="headingOne" style="margin-bottom:25px;" >
                                            <h4 class="mb-0" style="color: #0050b2;" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <a href="<?php echo e(config('app.baseURL')); ?>/referral-program"><button class="btn btn-primary" style="margin-top: 20px;">Learn More</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="single-widget-one wow fadeInUp" data-wow-delay="0.9s">
                                    <div class="w-100">
                                        <div class="faq-header" id="headingFive" style="margin-bottom:25px;">
                                        ...
                                        <div id="collapseFive" class="collapse" aria-labelledby="headingFive"
                                            data-bs-parent="#accordionExample">
                                            <div class="faq-body">
                                                <p>JFINSERV Referral Program for Business Associates helps you to accelerate the growth of your business and earnings. Whether you are a Financial Expert, Chartered Accountant, Tax Consultant, Insurance Agent, Loan Distribution Agency, Real Estate Broker or into some other businesses, let's work together for mutual benefit at zero investment.</p>
                                                <a href="<?php echo e(config('app.baseURL')); ?>/contact"><button class="btn btn-primary" style="margin-top: 20px;">Connect Now</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <br><br><br>
                                 ...
                                 <div class="section-title text-start">
                                <h2 class="mb-3"><span style="color: #0050b2;font-weight:500 !important">Still Have A Question? </span ></h2>
                                <p style="font-size:18px;color:#000;">Call us now at <a href="tel:+918329729190">+918329729190</a></p>
                                <!-- <p>Need some fast cash? Bad cradit history? We dont mind about your past,
                                    just the
                                    future.
                                    Try loan start and feel secure in your future.</p> -->
...
<!--                </div>-->
              ...
              <div class="holderCircle">
					...
					<div class="dotCircle">
						<span class="itemDot active itemDot1" data-tab="1">
							...
							<img class="img-fluid top-img1 img-new" src="<?php echo e(config('app.baseURL')); ?>/images\image1.png" alt="image">
							<span class="forActive"></span>
						</span>
						<span class="itemDot itemDot2" data-tab="2">
							<!-- <i class="ion-ios-chatboxes-outline"></i> -->
							<img class="img-fluid top-img1 img-new" src="<?php echo e(config('app.baseURL')); ?>/images\image2.png" alt="image">
							<span class="forActive"></span>
						</span>
						<span class="itemDot itemDot3" data-tab="3">
							<!-- <i class="ion-ios-person-outline"></i> -->
							<img class="img-fluid top-img1 img-new" src="<?php echo e(config('app.baseURL')); ?>/images\image3.png" alt="image">
							<span class="forActive"></span>
						</span>
						<span class="itemDot itemDot4" data-tab="4">
							<!-- <i class="ion-ios-pricetags-outline"></i> -->
							<img class="img-fluid top-img1 img-new" src="<?php echo e(config('app.baseURL')); ?>/images\image4.png" alt="image">
							<span class="forActive"></span>
						</span>
						<span class="itemDot itemDot5" data-tab="5">
							<!-- <i class="ion-ios-upload-outline"></i> -->
							<img class="img-fluid top-img1 img-new" src="<?php echo e(config('app.baseURL')); ?>/images\image5.png" alt="image">
							<span class="forActive"></span>
						</span>
        ...
        <section class="manage-c-finance pt-125 pb-140">
            <div class="container">
                ...
                <div class="row pt-60 gy-4 gy-xl-0">
                    ...
                    <div class="col-xl-4 col-md-8 box">
                        <div class="feature-card-widget-2 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="icon-bg-2">
                                ...
                                <img src="<?php echo e(asset('images\two.png')); ?>" alt="icon" class="icons">
                            </div>
                            <h5>Enjoy Low EMI</h5>
                    ...
                    <div class="col-xl-4 col-md-8 box">
                        <div class="feature-card-widget-2 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="icon-bg-3">
                                ...
                                <img src="<?php echo e(asset('images\three.png')); ?>" alt="icon" class="icons">
                            </div>
                    ...
                    <div class="col-xl-4 col-md-8 box d-flex">
                        <div class="feature-card-widget-2 wow fadeInUp" data-wow-delay="0.7s" style="width:100%;">
                            <div class="icon-bg-4">
          ...
          <section class=" pt-125 pb-140" id="banking-partners">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <div class="section-title">
...
<!-- <img src="https://www.iservefinancial.com/public/images/iservepartner/iserve-partners-new.png" style="width:100%;"> -->
            <div class="col-lg-12 col-md-12 col-sm-12 col-10">
                <div class="row">
                    ...
                    <div class="bank col-lg-2 col-md-3 col-12 col-sm-3 partners">
                                ...
                                <div class="single-widget-one wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="w-100">
                                        <div class="faq-header" id="headingOne">
                                            <h4 class="mb-0 heading-faq" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                                                aria-expanded="true" aria-controls="collapseOne">
                                                 What all documents are required to apply for any Loan?<i class="material-icons">add</i><i class="material-icons">remove</i>
                                            </h4>
                                        </div>
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            data-bs-parent="#accordionExample">
                                            <div class="faq-body">
                                                <p>
To apply for a home loan, mortgage loan, loan against property etc you need to submit documents such as a proof of identity, a proof of address, a loan application form that has been duly filled and your financial documents.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="single-widget-one wow fadeInUp" data-wow-delay="0.3s">
                                    <div class="w-100">
                                        <div class="faq-header" id="headingTwo">
                                            <h4 class="mb-0 heading-faq collapsed" data-bs-toggle="collapse"
                                                data-bs-target="#collapseTwo" aria-expanded="true"
                                                aria-controls="collapseTwo">
                                                How do you decide the eligibility for a loan against required amount? <i class="material-icons">add</i><i class="material-icons">remove</i>
                                            </h4>
                                        </div>
                                    ...
                                    <div class="w-100">
                                        <div class="faq-header" id="headingThree">
                                            <h4 class="mb-0 heading-faq collapsed" data-bs-toggle="collapse"
                                                ...
                                                How is the Equated Monthly Interest (EMI) calculated ?<i class="material-icons">add</i><i class="material-icons">remove</i>
                                            </h4>
                                        </div>
                                    ...
                                    <div class="w-100">
                                        <div class="faq-header" id="headingFour">
                                            <h4 class="mb-0 heading-faq collapsed" data-bs-toggle="collapse"
                                                ...
                                                Is there any tax benefits available on EMI ?<i class="material-icons">add</i><i class="material-icons">remove</i>
                                            </h4>
                                        </div>
                                ...
                                <div class="single-widget-one wow fadeInUp" data-wow-delay="0.9s">
                                    <div class="w-100">
                                        <div class="faq-header" id="headingFive">
                                            <h4 class="mb-0 collapsed heading-faq" data-bs-toggle="collapse"
                                                data-bs-target="#collapseFive" aria-expanded="true"
                                                aria-controls="collapseFive">
                                                Does JFINSERV charges any commission ?<i class="material-icons">add</i><i class="material-icons">remove</i>
                                            </h4>
                                        </div>
                                        <div id="collapseFive" class="collapse" aria-labelledby="headingFive"
                                            data-bs-parent="#accordionExample">
                    ...
                    <div class="col-md-4 offset-lg-1 mt-4 mt-md-0 ps-lg-5">
                        <div class="faq-img">
                           ...
                           <!-- Blog Posts start-->
        <section class="pb-120 bg_disable" style="padding:50px 0px 100px 0px !important">
            <div class="container">
                   <div class="section-title text-start">
...
<h6 style="font-weight: 600;margin-top: 10px;""><a href="<?php echo e(config('app.baseURL')); ?>/property/<?php echo e($get_property->property_id); ?>"><?php echo e($get_property->property_size); ?></a>
                    ...
                    <a href="<?php echo e(config('app.baseURL')); ?>/properties"><button class="btn btn-primary" style="margin-top: 40px;">View More</button></a>
                    </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-7">
                                    <div class="cta-content wow fadeInRight">
                                        <h2 class="mb-10">Do you have any questions, you want us to answer?</h2>
                                ...
                                <div class="col-md-5 text-center text-md-end">
                                    <div class="cta-content   text-md-end mt-3 mt-md-0">
                                        <a href="<?php echo e(config('app.baseURL')); ?>/contact"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u540016792/domains/jfinserv.com/public_html/resources/views/index.blade.php ENDPATH**/ ?>