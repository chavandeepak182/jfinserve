            ...
            <div class="card card-body shadow text-left text-dark" style="border-radius: 10px;">
              ...
              <form method="POST" action="<?php echo e(config('app.baseURL')); ?>/passwordreset">
                ...
                <div class="form-group" >
                   <input id="number" type="number" placeholder="Contact Number" class="form-control <?php if ($errors->has('contact_number')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('contact_number'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="contact_number" value="<?php echo e(old('contact_number')); ?>" required autocomplete="contact_number" autofocus>
