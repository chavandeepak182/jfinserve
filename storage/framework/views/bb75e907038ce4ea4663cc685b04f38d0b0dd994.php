...
<?php $__env->startSection('title', "Contract Loan in Pune | Loan against property in Pune - Jfinserv"); ?>
<?php $__env->startSection('description', "Explore competitive Contract Loan in Pune and loan against property services in Pune. Secure your dream home with our expert Contractual loan services."); ?>
<?php $__env->startSection('keywords', "Contract Loan in Pune, Loan against property in Pune, Contractual loan in Pune, Contractual loan services in PCMC"); ?>
...
<main>
    ...
    <section class="backbg pb-5" >
        <div class="container backbg">
                            ...
                            <div class="single-widget-one wow fadeInUp" data-wow-delay="0.1s">
                                <div class="w-100">
                                    ...
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        <div class="faq-body">
                                            <ul>
                                                <li><strong>Nationality:</strong> You need to be a Citizen of India with documents to prove your claim.</li>
                                                <li><strong>Occupation and Income:</strong> Your lender will request your occupation and income details to assess your creditworthiness.</li>
                                                <li><strong>Credit History:</strong> Your three-digit Credit Score, reflecting your history of loan repayments and other credit activities, will significantly influence your eligibility for a LAP.</li>
                                                <li><strong>Banking Relationship:</strong> If your relationship with your lender is good, you're less likely to face LAP rejection and may receive improved terms on loan amount, interest rates, and fees.</li>
                                                <li><strong>Market Value of Property:</strong> Your lender decides the loan amount and terms based on your property's market value, which must exceed the calculated loan amount.</li>
                                                <li><strong>Title of Property:</strong> Your lender requires you to be the property's current owner and provide clear title for co-ownership. Also, the property shouldn't be Contractd elsewhere.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                        <div class="faq-body">
                                            <ul>
                                                ...
                                                <li>Latest 3 years Income Tax Returns</li>
                                                <li>Proof of Business (for self-employed)</li>
                                                <li>Account statement for the last 6 months</li>
                                                <li>Latest 3 years company certified form No 16</li>
                                                <li>Latest 3 months company certified Salary Slips</li>
                                                <li>Copy a Partnership deed (Applicable for a partnership Firm)</li>
                                                <li>Copy of MOA and AA(Applicable for a Private Limited Company)</li>
                                                <li>All legal and title/Property Documents to be offered as collateral</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row box pt-90">
                <h2 class="display-8 text-top mb-4 text-center">Advantages of <span style="color: #4da9ea;">Jfinserv</span> Loans</h2>
                    ...
                    <div class="faq-widget">
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="single-widget-one wow fadeInUp" data-wow-delay="0.3s">
                                <div class="w-100">
                                    <div class="faq-header" id="headingTwo">
                                        <h4 class="mb-0 heading-faq collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">What types of properties can be Contractd with Jfinserv?<i class="material-icons">add</i><i class="material-icons">remove</i></h4>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/mortgage-loan.blade.php ENDPATH**/ ?>