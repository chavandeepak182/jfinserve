                            ...
                            <form method="POST" action="<?php echo e(config('app.baseURL')); ?>/loan/postAddPersonalDetail">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-12 working">
                                        ...
                                        <div class="col-md-3">
                                        <input id="mone_nsalary" class="form-control w-100 <?php if ($errors->has('mone_nsalary')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('mone_nsalary'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="mone_nsalary" >
                                        <?php if ($errors->has('mone_nsalary')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('mone_nsalary'); ?>
...
if (isset($messageCache)) { $message = $messageCache; }
                                        ...
                                        <div class="col-md-3">
                                        <input id="mone_gsalary" class="form-control w-100 <?php if ($errors->has('mone_gsalary')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('mone_gsalary'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="mone_gsalary" >
                                        <?php if ($errors->has('mone_gsalary')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('mone_gsalary'); ?>
                                          <span class="invalid-feedback" role="alert">
                                            <strong>This Field is required</strong>
                                          </span>
                                        <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                    ...
                                    <div class="col-md-12 working">
                                        ...
                                        <div class="col-md-3">
                                        <input id="mtwo_nsalary" class="form-control w-100 <?php if ($errors->has('mtwo_nsalary')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('mtwo_nsalary'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="mtwo_nsalary" >
                                        <?php if ($errors->has('mtwo_nsalary')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('mtwo_nsalary'); ?>
                                          <span class="invalid-feedback" role="alert">
                                            <strong>This Field is required</strong>
                                          </span>
                                        <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                        ...
                                        <div class="col-md-3">
                                        <input id="mtwo_gsalary" class="form-control w-100 <?php if ($errors->has('mtwo_gsalary')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('mtwo_gsalary'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="mtwo_gsalary" >
                                        <?php if ($errors->has('mtwo_gsalary')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('mtwo_gsalary'); ?>
                                          <span class="invalid-feedback" role="alert">
                                            <strong>This Field is required</strong>
                                          </span>
                                        <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                    ...
                                    <div class="col-md-12 working">
                                        ...
                                        <div class="col-md-3">
                                        <input id="mthree_nsalary" class="form-control w-100 <?php if ($errors->has('mthree_nsalary')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('mthree_nsalary'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="mthree_nsalary" >
                                        <?php if ($errors->has('mthree_nsalary')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('mthree_nsalary'); ?>
                                          <span class="invalid-feedback" role="alert">
                                            <strong>This Field is required</strong>
                                          </span>
                                        <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                        ...
                                        <div class="col-md-3">
                                        <input id="mthree_gsalary" class="form-control w-100 <?php if ($errors->has('mthree_gsalary')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('mthree_gsalary'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="mthree_gsalary" >
                                        <?php if ($errors->has('mthree_gsalary')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('mthree_gsalary'); ?>
                                          <span class="invalid-feedback" role="alert">
                                            <strong>This Field is required</strong>
                                          </span>
                                        <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                    ...
                                    <div class="col-md-12 business hidden">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                            <input id="yone_nprofit" class="form-control w-100 <?php if ($errors->has('yone_nprofit')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('yone_nprofit'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="yone_nprofit">
                                            <?php if ($errors->has('yone_nprofit')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('yone_nprofit'); ?>
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                            ...
                                            <div class="col-md-3">
                                            <input id="yone_depreciation" class="form-control w-100 <?php if ($errors->has('yone_depreciation')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('yone_depreciation'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="yone_depreciation">
                                            <?php if ($errors->has('yone_depreciation')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('yone_depreciation'); ?>
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-3">
                                            <input id="yone_interestloan" class="form-control w-100 <?php if ($errors->has('yone_interestloan')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('yone_interestloan'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="text" name="yone_interestloan">
                                            <?php if ($errors->has('yone_interestloan')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('yone_interestloan'); ?>
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                            ...
                                            <div class="col-md-3">
                                            <input id="yone_grossprofit" class="form-control w-100 <?php if ($errors->has('yone_grossprofit')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('yone_grossprofit'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="yone_grossprofit">
                                            <?php if ($errors->has('yone_grossprofit')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('yone_grossprofit'); ?>
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                        ...
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-3">
                                            <input id="yone_totalsales" class="form-control w-100 <?php if ($errors->has('yone_totalsales')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('yone_totalsales'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="yone_totalsales" >
                                            <?php if ($errors->has('yone_totalsales')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('yone_totalsales'); ?>
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                    ...
                                    <div class="col-md-12 business hidden">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                            <input id="ytwo_nprofit" class="form-control w-100 <?php if ($errors->has('ytwo_nprofit')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ytwo_nprofit'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="ytwo_nprofit" >
                                            <?php if ($errors->has('ytwo_nprofit')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ytwo_nprofit'); ?>
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                            ...
                                            <div class="col-md-3">
                                            <input id="ytwo_depreciation" class="form-control w-100 <?php if ($errors->has('ytwo_depreciation')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ytwo_depreciation'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="ytwo_depreciation" >
                                            <?php if ($errors->has('ytwo_depreciation')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ytwo_depreciation'); ?>
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-3">
                                            <input id="ytwo_interestloan" class="form-control w-100 <?php if ($errors->has('ytwo_interestloan')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ytwo_interestloan'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="text" name="ytwo_interestloan" >
                                            <?php if ($errors->has('ytwo_interestloan')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ytwo_interestloan'); ?>
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                            ...
                                            <div class="col-md-3">
                                            <input id="ytwo_grossprofit" class="form-control w-100 <?php if ($errors->has('ytwo_grossprofit')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ytwo_grossprofit'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="ytwo_grossprofit" >
                                            <?php if ($errors->has('ytwo_grossprofit')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ytwo_grossprofit'); ?>
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                        ...
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-3">
                                            <input id="ytwo_totalsales" class="form-control w-100 <?php if ($errors->has('ytwo_totalsales')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ytwo_totalsales'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="ytwo_totalsales" >
                                            <?php if ($errors->has('ytwo_totalsales')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ytwo_totalsales'); ?>
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                    ...
                                    <div class="col-md-12 business hidden">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                            <input id="ythree_nprofit" class="form-control w-100 <?php if ($errors->has('ythree_nprofit')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ythree_nprofit'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="ythree_nprofit" >
                                            <?php if ($errors->has('ythree_nprofit')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ythree_nprofit'); ?>
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                            ...
                                            <div class="col-md-3">
                                            <input id="ythree_depreciation" class="form-control w-100 <?php if ($errors->has('ythree_depreciation')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ythree_depreciation'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="ythree_depreciation" >
                                            <?php if ($errors->has('ythree_depreciation')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ythree_depreciation'); ?>
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-3">
                                            <input id="ythree_interestloan" class="form-control w-100 <?php if ($errors->has('ythree_interestloan')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ythree_interestloan'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="text" name="ythree_interestloan">
                                            <?php if ($errors->has('ythree_interestloan')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ythree_interestloan'); ?>
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                            ...
                                            <div class="col-md-3">
                                            <input id="ythree_grossprofit" class="form-control w-100 <?php if ($errors->has('ythree_grossprofit')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ythree_grossprofit'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="ythree_grossprofit" >
                                            <?php if ($errors->has('ythree_grossprofit')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ythree_grossprofit'); ?>
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                        ...
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-3">
                                            <input id="ythree_totalsales" class="form-control w-100 <?php if ($errors->has('ythree_totalsales')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ythree_totalsales'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="ythree_totalsales" >
                                            <?php if ($errors->has('ythree_totalsales')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('ythree_totalsales'); ?>
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            <?php unset($message);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vshoppng/jfinserv_vshoppng_tech/resources/views/loan/personal-detail.blade.php ENDPATH**/ ?>