 ...
 <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;" class="content"> 
  ...
  <tr>
    <td bgcolor="#ffffff" style="padding:5px 20px 20px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 15px; line-height: 24px; border-bottom: 1px solid #f6f6f6;">
      <p><b>Thanks <?php echo e($name); ?> for choosing Jfinserv as your lending partner. We'll get back to you soon.</b></p>
      <h3><b>The Submitted Details: Unveiling the Insight!</b></h3>
      <p>Name: <?php echo e($name); ?></p>
      <p>Contact No: <?php echo e($phone); ?></p>
      <p>Email: <?php echo e($email); ?></p> 
      <p>Loan Type: <?php echo e($loantype); ?></p>
      <p>Amount: <?php echo e($amount); ?></p>
      <p>Message: <?php echo e($message2); ?></p>  
    </td>
  </tr>
  <tr>
    <td align="center" bgcolor="#eee" style="padding: 15px 10px 15px 10px; color: #555555; font-family: Arial, sans-serif; font-size: 12px; line-height: 18px;">
      <center><b>Jfinserv Consultant India Private Limited © 2024 All rights reserved.</b><br/></center>
    </td>
  </tr>
</table>
</body>
</html><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/mail/userThanksMail.blade.php ENDPATH**/ ?>