                    ...
                    <div class="col-xl-6 col-lg-8">
                        <div class="banner-content py-5">
                            <div class="section-title text-start">
                                <span class="short-title wow fadeInUp" style="font-size: 20px;">CONTACT US</span>
                ...
                <div class="row gy-4 gy-lg-0">
                    ...
                    <div class="col-lg-6 offset-lg-1">
                        <div class="contact-form-widget">
                            <form action="<?php echo e(config('app.baseURL')); ?>/contact" method="post">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u540016792/domains/jfinserv.com/public_html/resources/views/contact.blade.php ENDPATH**/ ?>