...
<!--  <div class="col-lg-6"style="background:url(https://jfinserv.com/assets/img/banner/loginimg.png) no-repeat fixed;">
   ...
   <div class="login_leftbox col-lg-6 col-md-6 col-sm-12 col-12 mobile-view-top" style="background:url(<?php echo e(config('app.baseURL')); ?>/assets/img/banner/grc-bg-6b2fea043861dedae0e18db7c192ea80fdee6a660dce540c9919d32480891d14.svg) no-repeat fixed;">
        ...
        <div class="col-md-8">
            <div class="card">
               <h1 class="h2 text-left" style="margin-left:4%;margin-top:4%;"><b>Change Password</b></h1>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(config('app.baseURL')); ?>/change-forgot-password">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <a href="javascript:void(0);"><i class="fa fa-eye-slash" aria-hidden="true" style="padding-right:10px;"></i></a>
                ...
                <!--<p style="color:#000;">Already have an account? <a href="<?php echo e(config('app.baseURL')); ?>/login" style="color:blue;"> Login</a></p><br>-->
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/auth/reset-password.blade.php ENDPATH**/ ?>