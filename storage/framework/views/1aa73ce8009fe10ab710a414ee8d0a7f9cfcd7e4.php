...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
  <div class="navbar-header">
    <ul class="nav navbar-nav flex-row">
      <li class="nav-item mr-auto"><a class="navbar-brand" href="javascript:void(0);">
             ...
             <img src="<?php echo e(config('app.baseURL')); ?>/images/logo/logo.png" alt="logo" class="logo-image">
  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      <li class="nav-item  ">
        <a href="<?php echo e(config('app.baseURL')); ?>/admin/dashboard">
      ...
      <li class="nav-item has-sub">
                   ...
                   <?php if($role_id==1): ?>
      <li class="nav-item  ">
        <a href="<?php echo e(config('app.baseURL')); ?>/admin/commission/all">
      ...
      <?php endif; ?>
      <li class="nav-item  ">
        <a href="<?php echo e(config('app.baseURL')); ?>/admin/bank/all">
          <i class="feather icon-home "></i>
            <span class="menu-title" data-i18n="nav.app_email">Partner Banks</span>
        </a>
      </li>
      <li class="nav-item  ">
        <a href="<?php echo e(config('app.baseURL')); ?>/admin/property/all">
          <i class="feather icon-box"></i>
            <span class="menu-title" data-i18n="nav.app_email">Properties</span>
        </a>
      </li>
      <li class="nav-item  ">
        <a href="<?php echo e(config('app.baseURL')); ?>/admin/status/all">
          <i class="feather icon-box"></i>
      ...
      <?php if($role_id==1): ?>
      <li class="nav-item  ">
        <a href="<?php echo e(config('app.baseURL')); ?>/admin/admin/all">
      ...
      <!-- <li class="nav-item  ">
        <a href="<?php echo e(config('app.baseURL')); ?>/admin/blog/all">
          <i class="feather icon-box"></i>
      ...
      <!--  <li class="nav-item  ">
        <a href="<?php echo e(config('app.baseURL')); ?>/admin/mutual-fund/add">
          <i class="feather icon-box"></i>
      ...
      <li class="nav-item has-sub">
                        <a href="javascript:void(0);">
                            ...
                            <span class="menu-title" data-i18n="">Users</span>
                                                  ...
                                                  <ul class="menu-content" style="">
                                                       <?php if($role_id==1): ?>  
                     <li class="nav-item  ">
              <a href="<?php echo e(config('app.baseURL')); ?>/admin/user/all">
            ...
            <li class="nav-item  ">
              <a href="<?php echo e(config('app.baseURL')); ?>/admin/partner/all">
            ...
            <?php endif; ?>
            <!--                                      <li class="nav-item  ">-->
            <!--  <a href="<?php echo e(config('app.baseURL')); ?>/admin/docpendingall">-->
...
<li class="nav-item has-sub open">
            ...
            <!--</li>-->
                                                   ...
                                                   <li class="nav-item  ">
              <a href="<?php echo e(config('app.baseURL')); ?>/admin/pendingall">
 ...
 <li class="nav-item  ">
              <a href="<?php echo e(config('app.baseURL')); ?>/admin/approvedall">
             ...
             <li class="nav-item  ">
              <a href="<?php echo e(config('app.baseURL')); ?>/admin/rejectedall">
            ...
            <li class="nav-item  ">
              <a href="<?php echo e(config('app.baseURL')); ?>/admin/notificationall">
              
                <i class="feather icon-x-circle"></i>
                <span class="menu-title" data-i18n="nav.app_email">Notifications</span>
                <?php if($data['notificationcount']==0): ?>
                  <span class="number">
                  (<?php echo e($data['notificationcount']); ?>)
                  </span>
                <?php else: ?>
    ...
    <li class="nav-item has-sub">
                        <a href="javascript:void(0);">
                            ...
                            <span class="menu-title" data-i18n="">Referral Program</span>
                                                    ...
                                                    <ul class="menu-content" style="">
                    <li class="nav-item  ">
              <a href="<?php echo e(config('app.baseURL')); ?>/admin/refer_earn/all">
       ...
       <li class="nav-item  ">
              <a href="<?php echo e(config('app.baseURL')); ?>/admin/wallet/all">
            ...
            <li class="nav-item  ">
              <a href="<?php echo e(config('app.baseURL')); ?>/admin/redeem/all">
    ...
    <li class="nav-item has-sub">
                        <a href="javascript:void(0);">
                            ...
                            <span class="menu-title" data-i18n="">Web Forms & Leads</span>
                                                    ...
                                                    <ul class="menu-content" style="">
                   <li class="nav-item  ">
              <a href="<?php echo e(config('app.baseURL')); ?>/admin/contact/all">
            ...
            <li class="nav-item  ">
              <a href="<?php echo e(config('app.baseURL')); ?>/admin/referal_tools/all">
            ...
            <li class="nav-item  ">
              <a href="<?php echo e(config('app.baseURL')); ?>/admin/property_lead/all">
    ...
    <li class="nav-item has-sub">
            ...
            <!--<li class="nav-item  ">-->
            <!--  <a href="<?php echo e(config('app.baseURL')); ?>/admin/sanctioncalculator">-->
            ...
            <!--</li>-->
              <li class="nav-item  ">
              <a href="<?php echo e(config('app.baseURL')); ?>/admin/sanctioncalculatorhistory">
               ...
               <li class="nav-item  ">
              <a href="<?php echo e(config('app.baseURL')); ?>/admin/mis">
            ...
            <li class="nav-item  ">
              <a href="<?php echo e(config('app.baseURL')); ?>/admin/invoice">
...
<div class="buy-now no-print" style="margin-left:20px;">
    <a href="<?php echo e(config('app.baseURL')); ?>" class="btn btn-danger">Switch To Website</a>
</div>
...
<!-- END: Main Menu--><?php /**PATH /home/u540016792/domains/jfinserv.com/public_html/resources/views/layouts/left-menu.blade.php ENDPATH**/ ?>