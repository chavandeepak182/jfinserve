...
.pb-50{
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="stepper-widget mt-sm-5 px-3 px-sm-0">
                            <ul>
                                <li class="active mt-0"><a href="javascript:void(0);">
                                ...
                                <li class="active mt-0"><a href="javascript:void(0);">
                                        <div class="number"><i class="icon_check"></i> <span>2</span></div> Personal
                                        Details
                                    </a>
                                </li>
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-field">
                                            <span>₹ </span>
                                            <input type="number" id="loan_amount" value="<?php echo e($loan_amount); ?>" name="loan_amount" class="form-control" required>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
         ...
         $("input[value='<?php echo e($loan_type); ?>']").prop("checked",true);
         
          $("#select-loan-type option[value=<?php echo e($loan_new_type); ?>]").prop('selected',true);
     });
    </script>
<!-- <script type="text/javascript">
    $(document).ready(function (e) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u540016792/domains/jfinserv.com/public_html/resources/views/loan/apply-now.blade.php ENDPATH**/ ?>