...
/*.dropdown:hover .dropbtn {    background-color: var(--primary-color);;}*/
                    ...
                    <div class="col-md-4">
                        <div class="header-info-left">
                          ...
                          <!--   <div class="language-list">
                            ...
                            <div class="timestamp ms-4"> <i class="material-icons">schedule</i> Mon - Fri 10:00-18:00
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8">
    ...
    <!-- Header end --><?php /**PATH E:\xaamp7.4\htdocs\jfinserv\resources\views/layouts/header.blade.php ENDPATH**/ ?>