      ...
      <div class="container">
        <div class="row align-items-center justify-content-around text-center text-lg-left">
          ...
          <div class="col-md-9 col-lg-6 col-xl-5 order-lg-1" data-aos="fade-in">
            <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/health-insu.jpg" alt="Image" class="img-fluid term-fluid rounded shadow">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-around text-center text-lg-left">
          ...
          <div class="col-md-9 col-lg-6 col-xl-5 order-lg-2" data-aos="fade-left">
            <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/health-insu1.jpg" alt="Image" class="img-fluid rounded shadow">
    ...
    <section class="pb-0">
      <div class="container">
        ...
        <div class="col-md-9 col-lg-6 col-xl-5 order-lg-1" data-aos="fade-left">
          <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/health-insu3.jpg" alt="Image" class="img-fluid rounded shadow">
  ...
  <section class="pt-20">
    <div class="container">
      <div class="row align-items-center justify-content-around text-center text-lg-left">
        ...
        <div class="col-md-9 col-lg-6 col-xl-5 order-lg-2" data-aos="fade-left">
          <img src="<?php echo e(config('app.baseURL')); ?>/assets/img/health-insu4.jpeg" alt="Image" class="img-fluid rounded shadow">
            ...
            <div class="col col-md-10">
             ...
             <div class="row">
              <div class="card card-body shadow text-left text-dark" style="padding: 1.50rem;">
                <form method="post" action="<?php echo e(config('app.baseURL')); ?>/insurance/health-insurance" enctype='multipart/form-data'>
                   <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/insurance/health-insurance.blade.php ENDPATH**/ ?>