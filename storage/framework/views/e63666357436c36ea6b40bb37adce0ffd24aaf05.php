                                ...
                                <div class="col-12">
                                  ...
                                  <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item">
                                        <a href="<?php echo e(config('app.baseURL')); ?>/myrefercode">My Profile </a>
                                      </li>
                                      <li class="breadcrumb-item">
                                      All                                </li>
                                    </ol> 
        ...
        <form action="myprofile" method="post">
         ...
         <div class="row">
          ...
          <div class="col-sm-6" style="margin-bottom:20px;">
           ...
           <div class="form-group">
             <input type="text" name="name" class="form-control" value="<?php echo e($user->name); ?>" id="copy_link" placeholder="Name" style="width: 100%;" required="">
           </div>
         </div><br>
          ...
          <div class="col-sm-6" style="margin-bottom:20px;">
           ...
           <div class="form-group">
             <input type="number" name="contact_number" class="form-control" value="<?php echo e($user->contact_number); ?>" id="copy_link" placeholder="Contact Number" style="width: 100%;" readonly>
           </div>
         </div>
         ...
         <?php if($user->email!=$user->contact_number): ?>
          <div class="col-sm-6" style="margin-bottom:10px;">
              <label>Email*</label>
           <div class="form-group">
              <input type="email" name="email" class="form-control" value="<?php echo e($user->email); ?>" id="copy_link" placeholder="Email" style="width: 100%;" required="">
           </div>
         </div>
         <?php else: ?>
         ...
         <div class="col-md-6" style="margin-bottom:10px;padding-top: 4%;">
          ...
          <div class="col-sm-6" style="margin-bottom:15px;">
           ...
           <div class="form-group">
              <textarea type="text" name="present_address" required="" class="form-control" value="<?php echo e($user->present_address); ?>" id="copy_link" placeholder="Residential Address" style="width: 100%;"><?php echo e($user->present_address); ?></textarea>
           </div>
         </div>
           ...
           <div class="col-sm-6" style="margin-bottom:20px;">
              <label>City*</label>
           <div class="form-group">
              <input type="text" name="city" required="" class="form-control" value="<?php echo e($user->city); ?>" id="copy_link" placeholder="City" style="width: 100%;">
           </div>
         </div>
           <div class="col-sm-6" style="margin-bottom:20px;">
              <label>State*</label>
           <div class="form-group">
              <input type="text" name="state" required="" class="form-control" value="<?php echo e($user->state); ?>" id="copy_link" placeholder="State" style="width: 100%;">
           </div>
         </div>
           <div class="col-sm-6" style="margin-bottom:15px;">
              <label>Pincode*</label>
           <div class="form-group">
              <input type="text" name="pincode" required="" class="form-control" value="<?php echo e($user->pincode); ?>" id="copy_link" placeholder="Pincode" style="width: 100%;">
           </div>
         </div>
...
<?php echo $__env->make('layouts.user-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/myaccount/myprofile.blade.php ENDPATH**/ ?>