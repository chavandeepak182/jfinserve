...
<script>
  $(function(){
    $("#footer-table").DataTable({
      ...
      "ajax": "<?php echo e(config('app.baseURL')); ?>/admin/referal_tools/allData",
...
<?php echo $__env->make('layouts.admin-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vshoppng/jfinserv_vshoppng_tech/resources/views/admin/referal-tool.blade.php ENDPATH**/ ?>