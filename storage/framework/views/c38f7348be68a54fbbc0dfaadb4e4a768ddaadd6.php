 ...
 <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;" class="content"> 
  ...
  <tr>
    ...
    <td bgcolor="#ffffff" style="padding:5px 20px 20px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 15px; line-height: 24px; border-bottom: 1px solid #f6f6f6;">
      <p><b>Hi Admin</b>,<br>New User enquirer for property <b><?php echo $property_name ?> </b>.</p><br>
       <h3><b>User Details</b></h3>

  <p>Property ID: <?php echo $property_id ?></p>

  <p>Property Name : <?php echo $property_name ?></p>
...
</html><?php /**PATH /home/jfinserv.com/public_html/resources/views/mail/getPropertyEnquiryMail.blade.php ENDPATH**/ ?>