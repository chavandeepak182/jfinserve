<?php $__env->startSection('title', "Refer for loan with low ROI | Financial Consultants in Pune - Jfinserv"); ?>
<?php $__env->startSection('description', "Explore the best Financial Consultants in Pune with refer for secure loans with low ROI. Apply now for the more financial benefits."); ?>
<?php $__env->startSection('keywords', "Financial Consultants in Pune, Home finance in pune, Refer for loan with low ROI"); ?>
        ...
        <div class="row">
          <div class="col-md-4 mb-3 mb-md-0 tag-botm">
            ...
            <div class="card card-body bg-white h-100">
              <div class="icon"><img class="icons" alt="Digital products " src="<?php echo e(asset('images\program1.png')); ?>"></div>
               <div class="text">
                                <h3 class="bottom15">
...
Unlimited Earnings</span>
          ...
          <div class="col-md-4 mb-3 mb-md-0 tag-botm">
            <div class="card h-100 hover-box-shadow">
            <div class="card card-body bg-white h-100">
              <div class="icon"><img class="icons" alt="Websites Design" src="<?php echo e(asset('images\program2.png')); ?>"></div>
               <div class="text">
                                <h3 class="bottom15">
                                    <span class="d-inline-block">
Unlimited Rewards</span>
          ...
          <div class="col-md-4 mb-3 mb-md-0 tag-botm">
            <div class="card h-100 hover-box-shadow">
            <div class="card card-body bg-white h-100">
              <div class="icon"><img class="icons" alt="Enterprise software" src="<?php echo e(asset('images\program3.png')); ?>"></div>
               <div class="text">
                                <h3 class="bottom15">
  ...
  <div class="container">
    ...
    <div class="row align-items-center justify-content-around">
      <div class="col-md-9 col-lg-5" data-aos="fade-in">
        <img src="<?php echo e(asset('images\refer-earn1.jpg')); ?>" alt="Image" class="img-fluid rounded shadow">
        <!-- <img src="<?php echo e(asset('assets\img\rupee.png')); ?>" alt="Image" class="position-absolute p-0 col-4 col-xl-5 border border-white border-thick rounded-circle top left shadow-lg mt-5 ml-n5 ml-lg-n3 ml-xl-n5 d-none d-md-block" data-jarallax-element="-20 0"> -->
      </div>
...
<p class="text-new1">There are no limits to the number of employees you can refer. The more your refer, the more you earn.</p>
        ...
        <div class="row text-center">
          <div class="col-md-6 col-lg-4 mb-4 mb-md-5" data-aos="fade-up" data-aos-delay="100">
            <div class="mx-xl-4">
              <img src="<?php echo e(asset('images\benefits1.png')); ?>" alt="Kyan logo" class="mb-4 benefits">
             <h3 class="bottom15">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-md-5" data-aos="fade-up" data-aos-delay="200">
            <div class="mx-xl-4">
              <img src="<?php echo e(asset('images\benefits2.png')); ?>" alt="Atica logo" class="mb-4 benefits">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-md-5" data-aos="fade-up" data-aos-delay="300">
            <div class="mx-xl-4">
              <img src="<?php echo e(asset('images\benefits3.png')); ?>" alt="Treva logo" class="mb-4 benefits">
  ...
  <section style="padding: 5.5rem 0;  background-color: #e6f2f0 !important;">
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-8 col-lg-9 col-md-11">
          <form class="card card-body shadow" id="refer_your_friend_form" data-form-email="" novalidate="" action="<?php echo e(config('app.baseURL')); ?>/refer-earn" method="post">
...
Once the loan has been disbursed and confirmed by the bank/NBFC, your payout will be processed and the details can be seen through your dashboard. </p>
                    ...
                    <div class="col-md-5">
                        <div class="faq-img">
                            <img class="img-new" src="<?php echo e(asset('images\refer.jpg')); ?>" alt="faq-image" style="width:400px;object-fit:cover;">
                        </div>
                    </div>
                </div>
            </div>
...
<!--<script type="text/javascript">
  ...
  $('#copy_link').val("<?php echo e(config('app.baseURL')); ?>/referral-program?referral_link="+referral_link);
  ...
  $.ajax({
    ...
    url: "<?php echo e(config('app.baseURL')); ?>/refer-earn",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/refer-earn.blade.php ENDPATH**/ ?>