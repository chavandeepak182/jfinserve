    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          ...
          <a href="<?php echo e(config('app.baseURL')); ?>/admin/sanctioncalculator"> <button type="button" class="btn pull-right btn btn-primary panel-button">Eligiblity Calculation</button></a>
        </div>
...
<div class="modal fade" id="incomeModal" tabindex="-1" role="dialog" aria-labelledby="incomeModalLabel" aria-hidden="true">
        ...
        <div class="col-md-12 business" style="padding-top: 20px;padding-bottom: 20px;">
               ...
               <div class="col-md-12 col-sm-12 col-sm-12">
                 <div class="row form-group">
                  ...
                  <!-- <div class="col-lg-2 col-md-2 col-sm-2 <?php echo e($errors->has('age') ? ' has-error' : ''); ?>" style="padding-left: 20px !important;">
                    <div class="form-group">
                      <div class="controls">
                        <label class="label" for="">Name</label>
                        <textarea class="form-control" required="" value="" rows="1" data-validation-required-message="This field is required" type="text" name="name" value="0" placeholder="Name"></textarea>
 ...
 -->
                  ...
                  <!-- <div style="display: inline-flex;">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 <?php echo e($errors->has('bank_name') ? ' has-error' : ''); ?>" style="padding-left: 20px !important;">
                      <div class="form-group">
                        <div class="controls">
                          <label class="label" for="">Date of Birth</label>
                          <input class="form-control date_of_birth" required="" value="1985-02-11" data-validation-required-message="This field is required" type="date" name="dob" value="" placeholder="Date of Birth">
...
<script>
  $(function(){
    $("#footer-table").DataTable({
      ...
      "serverSide": true,
      "order": [[ 4, "desc" ]],
      "ajax": "<?php echo e(config('app.baseURL')); ?>/admin/sanctioncalculatorhistoryAll",
      ...
      "columns":[{
        ...
        },
         {
          ...
          "mRender": function(data, type, row){
            ...
            return "<a class=datatable-left-link href=<?php echo e(config('app.baseURL')); ?>/admin/sanctioncalculator/" + row.sanction_calc_id+"><span><button type='submit' class='btn btn-primary'>Details</button></span></a>";
            // }
          },
...
<?php echo $__env->make('layouts.admin-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/admin/history.blade.php ENDPATH**/ ?>