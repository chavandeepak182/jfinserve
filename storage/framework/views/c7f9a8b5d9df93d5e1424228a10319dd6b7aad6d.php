...
<!-- <section class="breadcrumb-area">
                                ...
                                <div class="col-12">
                                  ...
                                  <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item">
                                        <a href="<?php echo e(config('app.baseURL')); ?>/myrefercode"> Bank Details </a>
                                      </li>
                                      <li class="breadcrumb-item">
                                      All                                </li>
                                    </ol> 
      ...
      <div  class="form-section">
        ...
        <form action="<?php echo e(config('app.baseURL')); ?>/bank-details" method="post">
          <?php echo csrf_field(); ?>
         <div class="row">
          <div class="col-sm-6" style="margin-top: 20px;">
            <label>UPI ID</label>
           <div class="form-group">
             <input type="text" name="upi_id" class="form-control" value="<?php echo e($upi_id); ?>" value="" placeholder="abc@oksbi" style="width: 100%;">
           </div>
         </div>
          <div class="col-sm-6" style="margin-top: 20px;">
            <label>Gpay Number</label>
           <div class="form-group">
             <input type="text" name="gpay_number" class="form-control" value="<?php echo e($gpay); ?>" value="" placeholder="999XXXXXXXX" style="width: 100%;">
           </div>
         </div>
          <div class="col-sm-6" style="margin-top: 20px;">
            <label>PhonePe Number</label>
           <div class="form-group">
             <input type="text" name="phone_pay_number" class="form-control" value="<?php echo e($phone_pay); ?>" value="" placeholder="999XXXXXXXX" style="width: 100%;">
           </div>
         </div>
          <div class="col-sm-6" style="margin-top: 20px;">
            <label>Account Number</label>
           <div class="form-group">
             <input type="text" name="bank_account_number" class="form-control" value="<?php echo e($account); ?>" value="" placeholder="6243XXXXXX" style="width: 100%;">
           </div>
         </div>
          <div class="col-sm-6" style="margin-top: 20px;">
             <label>IFSC Code</label>
           <div class="form-group">
             <input type="text" name="ifsc_code" class="form-control" value="<?php echo e($ifsc); ?>" value="" placeholder="SBIXXXXX" style="width: 100%;">
           </div>
         </div>
          <div class="col-sm-6" style="margin-top: 20px;">
             <label>Account Holder Name</label>
           <div class="form-group">
             <input type="text" name="holder_name" class="form-control" value="<?php echo e($holder); ?>" value="" placeholder="Rahul XXXXX" style="width: 100%;">
           </div>
         </div>
      <br>
...
<?php echo $__env->make('layouts.user-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u540016792/domains/jfinserv.com/public_html/resources/views/myaccount/bankdetail.blade.php ENDPATH**/ ?>