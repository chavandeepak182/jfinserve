...
<?php $__env->startSection('title', "Overdraft facility | Financial Consultant in Pune - Jfinserv"); ?>
<?php $__env->startSection('description', "Discover JfInserv's versatile overdraft facility offering flexible credit solutions to meet your financial requirements. Contact financial consultant in Pune Now."); ?>
<?php $__env->startSection('keywords', "Overdraft facility, Financial Consultant in Pune, Credit Line, Flexible Financing, Revolving Credit, Emergency Fund, Financial Flexibility, Credit Facility"); ?>
...
<main>
                ...
                <div class="col-lg-12 mx-auto">
                    <div class="banner-content text-center">
                        <div class="section-title">
                            <h1 class="wow fadeInUp" style="font-size: 40px;">Overdraft Facility</h1>
        ...
        <div class="container backbg">
            <div class="row justify-content-center box">
                <div class="col-md-12 box-height">
                    ...
                    <p class="display-8 text-top wow fadeInUp bnr-description brdr-Block">Business proprietors often face scenarios necessitating extra funds to maintain seamless business operations. Such obstacles can momentarily pause business activities, proving detrimental irrespective of the business's scale. Any disruption in operations leads to financial setbacks. Should you encounter a shortfall in funds as a business owner, you can depend on JFinserv's Overdraft Facility. Tailored to address your urgent capital requirements, this service shields your business from adverse repercussions. <br/><br/>An Overdraft (OD) is a credit option provided by banks, enabling borrowers to cover business expenditures. It enables borrowing funds even when account balances are minimal. This facility offers a pre-established fund limit, which differs depending on the bank and customer connection. Banks levy interest solely on the amount utilized from the approved limit.</p>
                </div>
            </div>
            <div class="row box mt-3">
                <h2 class="display-8 text-top text-center pt-5"><span style="color: #d83733;">Features</span> of an Overdraft Facility Loan</h2>
                <p class="text-center pb-5">The pertinent aspects of an Overdraft Facility for business proprietors include:</p>
                <div class="col-md-3">
                    <div class="feature-box mb-4 text-center">
                        <p class="mb-3"><i class="fa-solid fa-building-columns fa-3x"></i></p>
                        <p>Banks provide borrowers in business lending with a defined credit limit through an Overdraft Facility, which may vary depending on individual borrowers.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="feature-box mb-4 text-center">
                        <p class="mb-3"><i class="fa-solid fa-percent fa-3x"></i></p>
                        <p>Interest on an Overdraft loan is exclusively computed according to the amounts utilized by the borrower.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="feature-box mb-4 text-center">
                        <p class="mb-3"><i class="fa-solid fa-right-left fa-3x"></i></p>
                        <p>Usually, loan repayments come with associated fees. However, when it comes to an Overdraft (OD), borrowers are exempt from such charges during repayment.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="feature-box mb-4 text-center">
                        <p class="mb-3"><i class="fa-solid fa-sack-dollar fa-3x"></i></p>
                        <p>In most cases, loan repayments entail accompanying fees. However, borrowers are relieved of such charges during repayment when utilizing an Overdraft (OD).</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="bg-white pt-20 pb-80" >
        <div class="container backbg">
            <div class="row box">
                <div class="col-md-12">
                            ...
                            <div class="single-widget-one wow fadeInUp" data-wow-delay="0.1s">
                                <div class="w-100">
                                    <div class="faq-header" id="heading1">
                                        <h4 class="mb-0 heading-faq" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="true" aria-controls="collapse1"><span style="color: #d83733;">Eligibility</span> for an Overdraft Facility Loan<i class="material-icons">add</i><i class="material-icons">remove</i>
                                        </h4>
                                    </div>
                                    <div id="collapse1" class="collapse show" aria-labelledby="heading1" data-bs-parent="#accordionExample">
                                        <div class="faq-body">
                                            <p>The Salary Overdraft facility from Bank gives you the flexibility to withdraw an amount up to twice of your in-hand salary at minimal interest rates that is charged as per usage - Conditions Apply. You are eligible for Overdraft, if your salary account with the bank and has regular salary credits, your minimum net monthly income is Rs. 15,000/-, and your company is on our approved list for overdraft facility.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="single-widget-one wow fadeInUp" data-wow-delay="0.1s">
                                <div class="w-100">
                                    <div class="faq-header" id="heading2">
                                        <h4 class="mb-0 heading-faq" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="true" aria-controls="collapse2"><span style="color: #d83733;">Documents Required</span> for an Overdraft Facility Loan<i class="material-icons">add</i><i class="material-icons">remove</i>
                                        </h4>
                                    </div>
                                    <div id="collapse2" class="collapse show" aria-labelledby="heading2" data-bs-parent="#accordionExample">
                                        <div class="faq-body">
                                            <ul>
                                                <li>KYC Documents (such as a passport, driver's license, Aadhaar card).</li>
                                                <li>Income Proof | Bank Statements</li>
                                                <li>Business Documents (such as business registration papers, balance sheets, profit and loss statements, etc.)</li>
                                                <li>Collateral Documents (such as property papers, land deeds, or vehicle ownership documents).</li>
                                                <li>Credit Score Report | Guarantor Documents</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                ...
                <h2 class="display-8 text-top text-center mt-5 pt-4"><span style="color: #d83733;">Different Categories</span> of Overdraft Accounts:</h2>
                <div class="col-md-6">
                    <div class="faq-widget">
                        <div class="accordion" id="accordionExample">
                            <div class="single-widget-one wow fadeInUp" data-wow-delay="0.3s">
                                <div class="w-100">
                                    <div class="faq-header" id="headingOne">
                                        <h4 class="mb-0 heading-faq collapsed" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">1. Individual Overdraft:<i class="material-icons">add</i><i class="material-icons">remove</i></h4>
                                    </div>
                                    
                                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        <div class="faq-body">
                                            <p>Geared towards personal use, enabling individuals to access funds beyond their account balance up to a set limit.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="single-widget-one wow fadeInUp" data-wow-delay="0.3s">
                                <div class="w-100">
                                    <div class="faq-header" id="headingTwo">
                                        <h4 class="mb-0 heading-faq collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo"> 2. Corporate Overdraft: <i class="material-icons">add</i><i class="material-icons">remove</i></h4>
                                    </div>
                                    
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                        <div class="faq-body">
                                            <p>Tailored for businesses to manage financial fluctuations and cover operational costs by offering overdraft facilities on their corporate accounts.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="single-widget-one wow fadeInUp" data-wow-delay="0.5s">
                                <div class="w-100">
                                    <div class="faq-header" id="headingThree">
                                        <h4 class="mb-0 heading-faq collapsed" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree"> 3. Collateralized Overdraft<i class="material-icons">add</i><i class="material-icons">remove</i></h4>
                                    </div>
                                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                        <div class="faq-body">
                                            <p>Backed by collateral such as deposits or securities, providing lower interest rates and higher credit limits compared to unsecured options.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="single-widget-one wow fadeInUp" data-wow-delay="0.7s">
                                <div class="w-100">
                                    <div class="faq-header" id="headingFour">
                                        <h4 class="mb-0 heading-faq collapsed" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour"> 4. Unsecured Overdraft: <i class="material-icons">add</i><i class="material-icons">remove</i></h4>
                                    </div>
                                    <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                        <div class="faq-body">
                                            <p>Lacking collateral requirements, this option may have higher interest rates and lower credit limits.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-100">
                                    <div class="faq-header" id="headingFive">
                                        <h4 class="mb-0 collapsed heading-faq" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="true" aria-controls="collapseFive">
                                            5. Inventory Overdraft: <i class="material-icons">add</i><i class="material-icons">remove</i>
                                        </h4>
                                    </div>
                                    <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                                        <div class="faq-body">
                                            <p>Aimed at businesses, allowing withdrawal of funds up to a specified limit, often based on the value of their inventory or receivables.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="single-widget-one wow fadeInUp" data-wow-delay="0.9s">
                                <div class="w-100">
                                    <div class="faq-header" id="headingSix">
                                        <h4 class="mb-0 collapsed heading-faq" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="true" aria-controls="collapseSix">
                                            6. On-Demand Overdraft:  <i class="material-icons">add</i><i class="material-icons">remove</i>
                                        </h4>
                                    </div>
                                    <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-bs-parent="#accordionExample">
                                        <div class="faq-body">
                                            <p>Permits account holders to overdraw their account balance without a predetermined limit, often associated with higher fees and interest rates.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <section class="backbg mb-5">
        <div class="container">
            <div class="row box">
                <h2 class="display-8 text-top pt-5 mb-5 text-center">Benifits of <span style="color: #4da9ea;">JFinserv's</span> Overdraft Facility</h2>
                <div class="col-md-6 col-lg-4 mb-3 mb-md-4 d-flex">
                    <div class="card hover-box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <p style="font-size: 14px !important;">Take advantage of our competitive interest rates, ensuring that you can comfortably manage your overdraft loan while safeguarding your financial stability.<br/></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-3 mb-md-4 d-flex">
                    <div class="card hover-box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <p style="font-size: 14px !important;">Tailor your repayment schedule to match your financial capabilities, whether you choose a shorter duration to reduce interest expenses or a longer duration for more manageable monthly payments.<br/></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-3 mb-md-4 d-flex">
                    <div class="card hover-box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <p style="font-size: 14px !important;">Easily request an overdraft loan directly through our user-friendly online application process, saving you time and effort.<br/></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-3 mb-md-4 d-flex">
                    <div class="card hover-box-shadow">
                        <img class="card-img-top hover-fade-out img-img" src="<?php echo e(config('app.baseURL')); ?>/images/service/qad.jpg" alt="Edutech chatbot">
                        <div class="card-body">
                            <h3 style="font-size: 18px !important;font-weight: 700;">Quick Approval and Disbursal: </h3>
                            <p style="font-size: 14px !important;">We grasp the importance of acquiring your overdraft loan swiftly. With our prompt approval and disbursement process, you'll soon find yourself accessing your overdraft loan sooner than expected.<br/></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row ">
                <div class="col-lg-6 mx-auto pb-5">
                    <div class="section-title">
                        ...
                        <p class="wow fadeInUp" data-wow-delay="0.3s">Receive an estimated total of your monthly installment payments, including a detailed breakdown of the overdraft loan.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-6 mx-auto">
                    <div class="section-title">
                        <h2 class="wow fadeInUp">One Step Closer To Finding Your <span style="color: #d83733;">Perfect Overdraft Loan!</span></h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="faq-widget">
                        <div class="accordion" id="accordionExample">
                            <div class="single-widget-one wow fadeInUp" data-wow-delay="0.1s">
                                <div class="w-100">
                                    <div class="faq-header" id="headingOne">
                                        <h4 class="mb-0 heading-faq" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">What is an overdraft facility?<i class="material-icons">add</i><i class="material-icons">remove</i>
                                        </h4>
                                    </div>
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        <div class="faq-body">
                                            <p>An overdraft facility is a credit arrangement provided by a financial institution that allows individuals or businesses to withdraw funds from their account even if the account balance is zero or negative, up to a specified limit.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="single-widget-one wow fadeInUp" data-wow-delay="0.3s">
                                <div class="w-100">
                                    <div class="faq-header" id="headingTwo">
                                        <h4 class="mb-0 heading-faq collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">How does the overdraft facility work?<i class="material-icons">add</i><i class="material-icons">remove</i></h4>
                                    </div>
                                    
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                        <div class="faq-body">
                                            <p>The overdraft facility works as a line of credit linked to the borrower's account. The borrower can withdraw funds up to the approved limit, and interest is charged only on the amount utilized. Repayment is typically flexible, and borrowers can deposit funds into the account to reduce the outstanding balance.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="single-widget-one wow fadeInUp" data-wow-delay="0.5s">
                                <div class="w-100">
                                    <div class="faq-header" id="headingThree">
                                        <h4 class="mb-0 heading-faq collapsed" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">What are the benefits of an overdraft facility from Jfinserv?<i class="material-icons">add</i><i class="material-icons">remove</i></h4>
                                    </div>
                                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                        <div class="faq-body">
                                            <p>Jfinserv's overdraft facility offers flexibility, convenience, and instant access to funds when needed. It provides a safety net for managing short-term cash flow needs, emergencies, or unexpected expenses without the need for prior approval.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="single-widget-one wow fadeInUp" data-wow-delay="0.7s">
                                <div class="w-100">
                                    <div class="faq-header" id="headingFour">
                                        <h4 class="mb-0 heading-faq collapsed" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">Who is eligible for an overdraft facility with Jfinserv?<i class="material-icons">add</i><i class="material-icons">remove</i></h4>
                                    </div>
                                    <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                        <div class="faq-body">
                                            <p>Eligibility for the overdraft facility based on factors such as creditworthiness, income, business turnover (for businesses), and relationship with Jfinserv. Both individuals and businesses may qualify for the facility.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="single-widget-one wow fadeInUp" data-wow-delay="0.9s">
                                <div class="w-100">
                                    <div class="faq-header" id="headingFive">
                                        <h4 class="mb-0 collapsed heading-faq" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="true" aria-controls="collapseFive">
                                            What documents are required to apply for an overdraft facility with Jfinserv?<i class="material-icons">add</i><i class="material-icons">remove</i>
                                        </h4>
                                    </div>
                                    <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                                        <div class="faq-body">
                                            <p>The documents required for applying for an overdraft facility may include identity proof, address proof, income documents (for individuals), business registration documents, financial statements (for businesses), and any other documents as requested by Jfinserv.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="single-widget-one wow fadeInUp" data-wow-delay="0.9s">
                                <div class="w-100">
                                    <div class="faq-header" id="headingSix">
                                        <h4 class="mb-0 collapsed heading-faq" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="true" aria-controls="collapseSix">How can I apply for an overdraft facility with Jfinserv?<i class="material-icons">add</i><i class="material-icons">remove</i>
                                        </h4>
                                    </div>
                                    <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-bs-parent="#accordionExample">
                                        <div class="faq-body">
                                            <p>You can apply for an overdraft facility with Jfinserv by contacting our branch or through our online application portal. Our dedicated team will guide you through the application process and assist you with the required documentation.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="single-widget-one wow fadeInUp" data-wow-delay="0.9s">
                                <div class="w-100">
                                    <div class="faq-header" id="headingSeven">
                                        <h4 class="mb-0 collapsed heading-faq" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="true" aria-controls="collapseSeven">Can I use the overdraft facility for personal and business purposes?<i class="material-icons">add</i><i class="material-icons">remove</i>
                                        </h4>
                                    </div>
                                    <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-bs-parent="#accordionExample">
                                        <div class="faq-body">
                                            <p>Yes, the overdraft facility can be used for both personal and business purposes, depending on the borrower's requirements. It provides flexibility and convenience for managing various financial needs effectively.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="single-widget-one wow fadeInUp" data-wow-delay="0.9s">
                                <div class="w-100">
                                    <div class="faq-header" id="headingEight">
                                        <h4 class="mb-0 collapsed heading-faq" data-bs-toggle="collapse" data-bs-target="#collapseEight" aria-expanded="true" aria-controls="collapseEight">How is the repayment of the overdraft facility managed?<i class="material-icons">add</i><i class="material-icons">remove</i>
                                        </h4>
                                    </div>
                                    <div id="collapseEight" class="collapse" aria-labelledby="headingEight" data-bs-parent="#accordionExample">
                                        <div class="faq-body">
                                            <p>The repayment of the overdraft facility is typically managed through periodic interest payments and principal repayments, if any. Borrowers can deposit funds into the account to reduce the outstanding balance and manage their cash flow efficiently.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row fadeInUp">
                                ...
                                <div class="col-md-6 mt-20">
                                    ...
                                    <select name="loantype" id="select-loan-type" class="form-control">
                                        ...
                                        <option id="Machinary Loan" value="Machinary Loan">Machinary Loan</option>
                                        <option id="Business Loan" value="Business Loan">Business Loan</option>
                                    </select>
                                </div>
                                <div class="col-md-6 mt-20">
                                    <label for="form-sub">Loan Amount</label>
                                    <input type="text" id="loan-amt" name="amount" class="form-control" placeholder="How much do you need?" required="">
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\public_html\resources\views/overdraft-facility.blade.php ENDPATH**/ ?>