        ...
        <div class="col-lg-10 col-md-12">
          <div class="card card-body shadow text-left text-dark" style="border-radius: 10px;">
            ...
            <h1 class="h2 text-left"><b>Register Your Account</b></h1>
              <div class="card-body">
                <form method="POST" action="<?php echo e(config('app.baseURL')); ?>/newregister">
                  <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>-->
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-12 mb-2">
                    <input id="contact_number" type="text" class="form-control <?php $__errorArgs = ['contact_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="contact_number" value="<?php echo e(old('contact_number')); ?>" required autocomplete="contact_number" placeholder="Contact Number" maxlength="10" pattern="\d{10}" title="Please enter exactly 10 digits" onkeypress="return isNumberKey(event)">
...
unset($__errorArgs, $__bag); ?>
    ...
    color: #57575b;border-radius: 5px;" required>
                  ...
                  <div class="col-md-6 mb-2">
                    <input id="name" type="number" class="form-control" name="amount" value="<?php echo e(old('amount')); ?>" required autocomplete="amount" autofocus placeholder="Amount">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-6 mb-2">
            <div class="input-group show_hide_password" id="show_hide_password">
              <input id="password" type="password" class="form-control form-control-password <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="col-md-6 mb-2">
            <div class="input-group show_hide_password-new" id="show_hide_password-new">
              <input id="password-confirm" type="password" class="form-control form-control-password <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm Password">
              <div class="input-group-addon">
                <a href="javascript:void(0);"><i class="fa fa-eye-slash" aria-hidden="true" style="padding-right:10px;"></i></a>
              </div>
...
unset($__errorArgs, $__bag); ?>
  ...
  <p style="color:#000;margin-left: 20px;">Already have an account? <a href="<?php echo e(config('app.baseURL')); ?>/login" style="color:blue;"> Login</a></p><br>
</div>
</div>
</div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u540016792/domains/jfinserv.com/public_html/resources/views/auth/register.blade.php ENDPATH**/ ?>