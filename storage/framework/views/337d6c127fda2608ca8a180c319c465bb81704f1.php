  ...
  <div class="content-wrapper">
    ...
    <div class="content-body" id="Many">
      ...
      <section class="simple-validation">
        <form action="<?php echo e(config('app.baseURL')); ?>/admin/add_sanction_calculator" method="POST">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card">
               ...
               <div class="row">
                      <div class="col-lg-2 <?php echo e($errors->has('bank_name') ? ' has-error' : ''); ?>">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <?php if($errors->has('master_income_margin')): ?>
                                <span class="help-block">
                                  <strong><?php echo e($errors->first('master_income_margin')); ?></strong>
                                </span>
                              <?php endif; ?></div>
                            </div>
                          </div>
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <?php if($errors->has('master_rental_margin')): ?>
                                <span class="help-block">
                                  <strong><?php echo e($errors->first('master_rental_margin')); ?></strong>
                                </span>
                              <?php endif; ?></div>
                            </div>
                          </div>
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <?php if($errors->has('master_ltv_margin')): ?>
                                <span class="help-block">
                                  <strong><?php echo e($errors->first('master_ltv_margin')); ?></strong>
                                </span>
                              <?php endif; ?></div>
                            </div>
                          </div>
               ...
               <div class="col-md-12 col-sm-12 col-sm-12" style="padding-left:30px !important;">
                 <div class="row form-group">
                   <div class="controls col-lg-3 col-md-3 col-sm-3">
                        <label class="label" for="">Name</label>
                        <textarea class="form-control name" required="" value="" rows="1" data-validation-required-message="This field is required" type="text" name="name" value="0" placeholder="Name"></textarea>
                     ...
                     <div class="controls col-lg-3 col-md-3 col-sm-3">
                          ...
                          <input class="form-control date_of_birth dob" required="" value="1985-02-11" data-validation-required-message="This field is required" type="date" name="dob" value="" placeholder="Date of Birth">
        ...
        <div class="col-md-12 businessapplicant" style="padding-top: 20px;padding-bottom: 20px;">
               ...
               <div class="col-md-12 workingapplicant hidden" style="padding-top: 20px;padding-bottom: 20px;">
              ...
              <div class="card-content businessapplicant">
                <div class="card-body">
                      ...
                      <div class="col-md-2 year_one_show">
                        <h6 class="card-title" style="text-align: center;">Year 1</h6>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 <?php echo e($errors->has('bank_name') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-2">
                              <h6 class="card-title" style="text-align: center;">Latest Yrs (AVG)</h6>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 <?php echo e($errors->has('bank_name') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-2">
                              <h6 class="card-title" style="text-align: center;">All Yrs (AVG)</h6>
     ...
     <!-- Start Working Applicant -->

    <div class="card-content workingapplicant hidden">
      <div class="card-body">
     ...
     <!-- End Business Applicant -->


       <div class="col-md-12">
              <label class="label" for="existing"><input type="checkbox" value="1" class="existing_loan_check" name="existing_loan_check"> &nbsp; <b style="font-size: 16px;">Co Applicant</b> </label>
            </div>


    <!--         <div class="card-header existing_loan hidden">
              <h6 class="card-title">Co-Applicant</h6>
            </div><br> -->

                                 <div class="col-md-12 existing_loan hidden" style="padding-top: 20px;padding-bottom: 20px;">
                <div class="form-check form-check-inline me-5  selfTab">
                  <input class="form-check-input" type="radio" name="profession_type1" id="selfTab1" checked="" value="self1" onclick="show3();">
                  <label class="form-check-label" for="self"><b style="font-size: 16px;">Self Employed/ Business Professionals</b></label>
                </div>
                <div class="form-check form-check-inline active me-5">
                  <input class="form-check-input" type="radio" name="profession_type1" id="salariedTab1"  value="salaried1" onclick="show4();">
                  <label class="form-check-label" for="married"><b style="font-size: 16px;">Salaried Employees</b> </label>
                </div>
              </div>
              <br>

                <div class="col-md-12 businesscoapplicant existing_loan hidden" style="padding-top: 20px;padding-bottom: 20px;">
               ...
               <div class="col-md-12 workingcoapplicant hidden" style="padding-top: 20px;padding-bottom: 20px;">
            ...
            <br>
             ...
             <div class="existing_loan hidden">

              <!-- Business Co Applicant -->

              <div class="col-md-12">
              <div class="row businesscoapplicant">
                ...
                <!--           <div class="col-lg-12 col-md-12 col-sm-6 <?php echo e($errors->has('bank_name') ? ' has-error' : ''); ?>">
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 <?php echo e($errors->has('bank_name') ? ' has-error' : ''); ?> printmarginnew">
                            <div class="form-group">
                              <div class="controls">
                                <label class="label main-label" for="">Total Profit</label>
                                <input class="form-control label-input" readonly="" value="0" style="visibility: hidden;">
                  ...
                  <!--  <div class="col-lg-12 <?php echo e($errors->has('bank_name') ? ' has-error' : ''); ?>" id="input_fields_wrap_dep">
              ...
              <!--   <div class="col-lg-12 col-md-12 col-sm-6 <?php echo e($errors->has('bank_name') ? ' has-error' : ''); ?>" style="visibility: hidden;">
                  <div class="form-group">
                    <div class="controls">
                      <label class="label" for="">Date of ITR</label>
            ...
            <!-- End Business Co Applicant -->


            <!-- Start Salary Co Applicant -->

            <div class="row workingcoapplicant hidden">
          ...
          <div class="col-md-2" style="padding-right: 15px !important;">
            ...
            <!-- End Salary Co Applicant -->


          </div>
   </div>

     <!-- End Working Applicant -->
<!--    </div>
 ...
 <!-- Start Co2 -->
               <div class="col-md-12">
                            <label class="label" for="existing"><input type="checkbox" value="2" class="existing_loan_check1" name="existing_loan_check1"> &nbsp; <b style="font-size: 16px;">Co Applicant1</b> </label>
                          </div>
                     ...
                     <!--      <div class="card-header existing_loan1 hidden">
                            <h6 class="card-title">Co-Borrower1</h6>
                                              ...
                                              <div class="col-md-12 existing_loan1 hidden" style="padding-top: 20px;padding-bottom: 20px;">
                <div class="form-check form-check-inline me-5  selfTab2">
                  <input class="form-check-input" type="radio" name="profession_type2" id="selfTab2" checked="" value="self2" onclick="show5();">
                  <label class="form-check-label" for="self"><b style="font-size: 16px;">Self Employed/ Business Professionals</b></label>
                </div>
                <div class="form-check form-check-inline active me-5">
                  <input class="form-check-input" type="radio" name="profession_type2" id="salariedTab2"  value="salaried2" onclick="show6();">
                  <label class="form-check-label" for="married"><b style="font-size: 16px;">Salaried Employees</b> </label>
                </div>
              </div>
              <br>

                          <div class="col-md-12 businessco1applicant existing_loan1 hidden" style="padding-top: 20px;padding-bottom: 20px;">
              ...
              <div class="col-md-12  workingco1applicant hidden" style="padding-top: 20px;padding-bottom: 20px;">
             ...
             <div class="existing_loan1 hidden">

              <!-- Business Co1 Applicant -->

              <div class="col-md-12">

                          <div class="row businessco1applicant" style="flex-wrap: wrap;margin-right: -14px;margin-left: 0px!important;padding-right: 0px!important;padding-left: 14px!important;flex: 0 0 103%!important;max-width: 135%!important;">
...
<div class="row workingco1applicant hidden">
              <div class="row">          
                <div class="col-md-2" style="padding-left: 15px !important;padding-right: 15px !important;">
            <h6 class="card-title" style="text-align: center;visibility: hidden;">Average</h6>
...
<div class="col-lg-12 col-md-12 col-sm-6">
 ...
 <input type="hidden" class="form-control required plus_emi_value" value="0" id="proposalTitle3">
 <input type="hidden" class="form-control required plus_project_value" value="0" id="proposalTitle3">
 
<div class="col-lg-12 col-md-12 col-sm-12 disposal-income-one" style="margin-bottom: 30px;padding-top: 20px;">
  ...
  <div class="row" >
    ...
    <div class="form-group">
      ...
      <label for="proposalTitle3" class="main-label-itr">
       Margin Deduction (<span class="marginprecentageset"></span>)
      </label>
      <input class="form-control label-input" readonly="" value="0" style="visibility: hidden;">
    </div>
  ...
  <div class="col-md-12" > 
    ...
    <div class="col-sm-4">
     <h5 class="move-right" style="font-size: 0.8rem;margin-bottom: 10px;">As per latest ITR & salary </h5>
     <div class="col-md-12" > 
      <div class="form-group">
...
<div class="col-sm-4">
  <h5 class="move-right" style="font-size: 0.8rem;"><input type="checkbox" class="average_itr" name="average_itr"> average of Three ITR & 6 Month salary </h5>
...
<div class="row sanctionsave">

 <div class="col-lg-6" style="margin-left:30px;" >
  <div class="form-submit mt-10 mb-30">
 
   <button type="button" id="target" class="btn btn-success">Save
...
<br>
  ...
  var dob=$( ".dob" ).val();
   ...
   var time_period=$( ".time_period" ).val();
    ...
    $.ajax({
     type: "post",
     url : "https://jfinserv.com/admin/calculate/save",
    data : { "content" : content,"name" : name,"dob" : dob,"age" : age,"interest_rate" : interest_rate,"time_period" : time_period,"emi" : emi,"date" : date },
...
<script>
 function show1() {
  ...
  $('.workingapplicant').addClass('hidden');
  $('.businessapplicant').removeClass('hidden');
...
function show2() {
  ...
  $('.businessapplicant').addClass('hidden');
  $('.workingapplicant').removeClass('hidden');
 ...
 function show3() {
  var radioButton = document.getElementById("salariedTab1");
  radioButton.checked = false;

  $('.workingcoapplicant').addClass('hidden');
  $('.businesscoapplicant').removeClass('hidden');
...
function show4() {
  ...
  $('.businesscoapplicant').addClass('hidden');
  $('.workingcoapplicant').removeClass('hidden');
  var radioButton = document.getElementById("selfTab1");
  radioButton.checked = false;
...
function show5() {
  var radioButton = document.getElementById("salariedTab2");
  radioButton.checked = false;

  $('.workingco1applicant').addClass('hidden');
  $('.businessco1applicant').removeClass('hidden');
...
function show6() {
  ...
  $('.businessco1applicant').addClass('hidden');
  $('.workingco1applicant').removeClass('hidden');
  var radioButton = document.getElementById("selfTab2");
  radioButton.checked = false;
...
$('input').on('blur focusout',function(){
  ...
  var emi_add=0;
  var project_cost_add=0;
      $("#input_fields_wrap_one").on("keyup blur focusout","input", function(e){ //user click on remove text

          var count=$('#input_fields_wrap_one input[type="text"]').length;
          var project_cost_add = 0;
           for(var j = 1; j < count+1; j++){
        
          var project_cost_new=$('#input_fields_wrap_one').find(".project_cost"+j+"").val();
           if (project_cost_new==undefined || project_cost_new==null || project_cost_new=="") {
               var project_cost_new=0;
           }
          
          var project_cost_add=parseFloat(project_cost_add)+parseFloat(project_cost_new);
        
        
       }
       var project_cost_first=$(".project_cost").val();
       
       var total_project_cost_value=parseFloat(project_cost_first)+parseFloat(project_cost_add);
 $('.total_project_cost_value').val(total_project_cost_value);
       console.log("projectcost"+project_cost_add)
       
      
          
 $(".plus_project_value").attr('value',project_cost_add);
 
 
    });
    
          $("#input_fields_wrap").on("keyup blur focusout","input", function(e){ //user click on remove text

          var count=$('#input_fields_wrap input[type="text"]').length;
          var emi_add = 0;
           for(var i = 1; i < count+1; i++){
        
          var emi_new=$('#input_fields_wrap').find(".running_emi"+i+"").val();
           if (emi_new==undefined || emi_new==null || emi_new=="") {
               var emi_new=0;
           }
          
          var emi_add=parseFloat(emi_add)+parseFloat(emi_new);
        
        
       }
       
        var emi_first=$(".running_emi").val();
          
 $(".plus_emi_value").attr('value',emi_add);
 
 var total_emi_value=parseFloat(emi_first)+parseFloat(emi_add);
 $('.total_emi_value').val(total_emi_value);
...
// End of Co-Borrower2 Salaried
 ...
 var running_emi_one=$('#input_fields_wrap').find('.running_emi2').val();
//  console.log(running_emi_one);
...
// alert(project_cost_two);
 var total_project_cost=parseFloat(project_cost)+parseFloat(total_new_project_cost);
...
var co_self_total_deduction_year_three_average=parseFloat(co_self_latest_monthly_average_tax)+parseFloat(co_self_latest_monthly_average_ded);
  ...
  var new_deduction=parseFloat(self_total_deduction_year_three_average)+parseFloat(co_self_total_deduction_year_three_average)+parseFloat(six_salary_deduction)+parseFloat(co_six_salary_deduction)+parseFloat(six_salary_tax)+parseFloat(co_six_salary_tax);

  var new_deduction_two=parseFloat(self_total_deduction_year_all_average)+parseFloat(co_self_total_deduction_year_all_average)+parseFloat(average_salary_deduction)+parseFloat(co_average_salary_deduction)+parseFloat(average_salary_tax)+parseFloat(co_average_salary_tax);
...
var interest_rate=6.7;
var number_of_month=360;
...
console.log(ltv_loan_amount_applied);
console.log(eligilble_as_per_average_income);
console.log(value_to_be_consider_two);
console.log(ltv_takeover);


var maximum_eligible_loan = Math.min(parseFloat(ltv_loan_amount_applied),parseFloat(eligilble_as_per_average_income),Math.max(parseFloat(value_to_be_consider_two),parseFloat(ltv_takeover)));

$('.maximum_eligible_loan_average').val(maximum_eligible_loan);

var maximum_eligible_loan_latest = Math.min(parseFloat(ltv_loan_amount_applied),parseFloat(eligilble_as_per_latest),Math.max(parseFloat(value_to_be_consider_two),parseFloat(ltv_takeover)));
...
<?php echo $__env->make('layouts.admin-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u838013575/domains/jfinserv.com/public_html/resources/views/admin/sanctioncalculator.blade.php ENDPATH**/ ?>