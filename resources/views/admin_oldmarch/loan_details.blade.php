            ...
            <div class="contact-form">
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('loan_type') ? ' has-error' : '' }}">
                  <label class="margin-label">Loan Type</label>
              ...
              <div class="row col-lg-12 col-md-12 col-sm-6">
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('document') ? ' has-error' : '' }}">
                  <label class="margin-label">Documents</label>
                  <div class="form-group">
                    <div class="controls">
                      <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                      @foreach($loandetails->loandoc as $loan_document)
                      <iframe class="mr-1 mb-1 mt-1" src="{{config('app.baseURL')}}/storage/app/{{$loan_document->document}}" id="pdf_display_frame" width="48%" height="500px"></iframe>
                ...
                @if($loandetails->note!= '[]')
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('note') ? ' has-error' : '' }}">
                  <label class="margin-label">Pending Documents</label>
                  <div class="form-group">
                    <div class="controls">
                      <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                        <textarea class="form-control">{{$loandetails->note}}</textarea>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{config('app.baseURL')}}/admin/loandocpending/{{$loandetails->loan_id}}" method="GET" id="userForm">
