                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="banner-content">
                            ...
                            <a href="https://jfinserv.com/login" data-wow-delay="0.5s"
                    ...
                    <div class="row gy-xl-0 gy-4">
                        ...
                        <div class="col-xl-3 col-md-6 offset-xl-1 ">
                            <div class="apply-topics">
                                ...
                                <a href="https://jfinserv.com/login" class="theme-btn mt-20 w-100">Apply for loan</a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <div class="section-title">
                            ...
                            <p class="wow fadeInUp" data-wow-delay="0.3s">We work with 50 plus Top Banks & NBFCs</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-5 text-center text-md-end">
                                    <div class="cta-content   text-md-end mt-3 mt-md-0">
                                        <a href="https://jfinserv.com/contact"
