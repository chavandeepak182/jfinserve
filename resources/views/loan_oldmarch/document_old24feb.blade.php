...
.data-dz-errormessage{
 ...
 <main>
                    ...
                    <div class="col-md-9">
                        <div class="loan-details-widget bg_white">
                            <form action="{{config('app.baseURL')}}/loan/postAddDocument" enctype="multipart/form-data" method="POST" id="form1" name="form1">
                                ...
                                <input type="button" name="dhhh" onclick="abc();" value="hjfcd">
                                <div class="row mt-5">
                                    <div class="col-md-12">
  ...
  <script type="text/javascript">
       function abc() {
//         var someimage = document.getElementsByClassName('dz-preview').secondChild.getAttribute("src");
// alert(someimage);
var someimage = document.getElementsByClassName('dz-preview');
alert(someimage);
var mydiv = someimage.getElementsByClassName('dz-image');
alert(mydiv);
var myimg = mydiv.getElementsByTagName('img');
var mysrc = myimg.src;
alert(mysrc);
        //   var filename=document.getElementsByClassName('data-dz-name').value;
        // alert(filename);
       }
