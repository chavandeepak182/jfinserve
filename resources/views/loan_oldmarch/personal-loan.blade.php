@extends('layouts.app', ['title' => 'Simplified Loans - Low Rates. Great Offers. Apply for Personal loan in 30 seconds'])
@section('keywords', 'loan, loans, home loan, personal loan, current loan rates india, loan calculator india, best loan rates, cheapest loans india, instant loans, apply for home loan, instant home loan, instant personal loan, apply for personal loan')
@section('description', 'Buying your dream home, vacation, higher education or any Emergency, get money when you it with our loan products.')
@section('content')
<style type="text/css">
    ...
    <div class="container">
      <div class="row ">
        <div class="col-md-9 col-lg-8 col-xl-7">
          ...
          <h4 class="display-5">Get money when you need it<br> 
           with our personal loans. 
          </h4>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-around text-center text-lg-left">
          ...
          <div class="col-md-9 col-lg-6 col-xl-5 order-lg-1" data-aos="fade-in">
            <img src="{{config('app.baseURL')}}/assets/img/personal-loan.jpg" alt="Image" class="img-fluid term-fluid rounded shadow">
      ...
      <div class="container">
        ...
        <div class="row text-center">
          <div class="col-md-6 col-lg-4 mb-4 mb-md-5" data-aos="fade-up" data-aos-delay="100">
            <div class="mx-xl-4">
              <img src="{{asset('assets\img\money.png')}}" alt="Debt Consolidation" class="mb-4">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-md-5" data-aos="fade-up" data-aos-delay="200">
            <div class="mx-xl-4">
              <img src="{{asset('assets\img\plane.png')}}" alt="Vacation or Trips" class="mb-4">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-md-5" data-aos="fade-up" data-aos-delay="300">
            <div class="mx-xl-4">
              <img src="{{asset('assets\img\home-repair.png')}}" alt="Home Improvements" class="mb-4">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-md-5" data-aos="fade-up" data-aos-delay="400">
            <div class="mx-xl-4">
              <img src="{{asset('assets\img\checked.png')}}" alt="Moving expenses" class="mb-4">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-md-5" data-aos="fade-up" data-aos-delay="500">
            <div class="mx-xl-4">
              <img src="{{asset('assets\img\heart.png')}}" alt="Unexpected Expenses" class="mb-4">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-md-5" data-aos="fade-up" data-aos-delay="600">
            <div class="mx-xl-4">
              <img src="{{asset('assets\img\wedding.png')}}" alt="Weddings" class="mb-4">
              <h5>Weddings</h5>
              ...
              <div class="col col-md-10">
               ...
               <div class="row">
                <div class="card card-body shadow text-left text-dark" style="padding: 1.50rem;">
                  <form method="post" action="{{config('app.baseURL')}}/loans/loan-enquiry/4" enctype='multipart/form-data'>
                   <input type="hidden" name="_token" value="{{csrf_token()}}">
