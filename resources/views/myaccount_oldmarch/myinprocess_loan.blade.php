                          ...
                          <div class="content-header row">
                            <div class="content-header-left col-md-9 col-12 mb-2">
                              <div class="row breadcrumbs-top">
                                <div class="col-12">
                                  <h2 class="content-header-title float-left mb-0">Loan In Process</h2>
                                  <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item">
                                        <a href="{{config('app.baseURL')}}/myloaninprocess/{{$user_id}}"> Loan In Process </a>
                                      </li>
                                      <li class="breadcrumb-item">
                                      All                                </li>
                                    </ol> 
                                ...
                                <div class="col-12">
                                  <div class="card">
                                    <div class="card-header">
                                      <h4 class="card-title">Loan In Process </h4>
