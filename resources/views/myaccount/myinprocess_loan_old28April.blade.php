                                ...
                                <div class="col-12">
                                  ...
                                  <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item">
                                        <a href="{{config('app.baseURL')}}/myloaninprocess/{{$user_id}}"> Loan Application </a>
                                      </li>
                                      <li class="breadcrumb-item">
                                      All                                </li>
                                    </ol> 
                                ...
                                <div class="col-12">
                                  ...
                                  <div class="card">
                                    ...
                                    <div class="card-header">
                                         <a href="https://jfinserv.com/apply-now" data-wow-delay="0.5s" class="wow fadeInUp theme-btn theme-btn-sm" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;margin-left:0px !important;font-size:16px !important;height: 40px;
    line-height: 40px;float:right;"> Start Application
                            </a>
                                        <!--<a href="{{config('app.baseURL')}}/apply-now" style="margin-top:10px;margin-right:10px"> <button type="button" class="btn pull-right btn btn-primary panel-button" style="float:right;"> Apply For New Loan </button></a>-->
                        ...
                        <script>
                          $(function(){
                            ...
                            //   "stateSave": true,
                              ...
                              "paging": true,
                              "order": [[ 0, "desc" ]],
                              "ajax": "{{config('app.baseURL')}}/myloaninprocess/all/{{$user_id}}",
                              ...
                              "columns":[{
                                ...
                                "targets":-1,
                                  ...
                                  "mRender": function(data, type, row){
                                     return "<a class=datatable-left-link href={{config('app.baseURL')}}/accountLoanDetails/" + row.loan_id+"><span><button type='submit' class='btn btn-primary mr-1'>Details</button></span></a>";
                                  },
                              },
                                ]
                              });
                            ...
                            //   "stateSave": true,
                              ...
                              "paging": true,
                              "order": [[ 0, "desc" ]],
                              "ajax": "{{config('app.baseURL')}}/myloandraft/all/{{$user_id}}",
                            ...
                            //   "stateSave": true,
                              ...
                              "paging": true,
                              "order": [[ 0, "desc" ]],
                              "ajax": "{{config('app.baseURL')}}/myloandetails/all/{{$user_id}}",
