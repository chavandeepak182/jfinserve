                                ...
                                <div class="col-12">
                                  ...
                                  <div class="card">
                                    ...
                                    <div class="card-header">
                                         <a href="{{config('app.baseURL')}}/apply-now" data-wow-delay="0.5s" class="wow fadeInUp theme-btn theme-btn-sm" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;margin-left:0px !important;font-size:16px !important;height: 40px;
