...
<!-- <section class="breadcrumb-area">
                                ...
                                <div class="col-12">
                                  ...
                                  <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                      ...
                                      <li class="breadcrumb-item">
                                        <a href="{{config('app.baseURL')}}/myreferearn/{{$user_id}}"> Refer & Earn </a>
                                      </li>
                                      <li class="breadcrumb-item">
                                      All                                </li>
                                    </ol> 
         ...
         <div class="row">
          <div class="col-sm-6">
           ...
           <div class="form-group">
             <input type="text" name="copy_link" class="form-control" value="{{$user->referal_code}}" id="copy_link" value="" readonly="" placeholder="" style="width: 100%;">
           </div>
         </div>
         <div class="col-sm-2">
  ...
  $(function(){
    $("#footer-table").DataTable({
      ...
      "ajax": "{{config('app.baseURL')}}/myreferearn/all/{{$user_id}}",
     ...
     {  
      ...
      "mRender": function(data, type, row){
        if(row.is_claim==1 && row.loan.status==2){
          return "<a href='{{config('app.baseURL')}}/claim/"+row.loan_id+"'><button class='btn btn-primary'><span style='color:#fff;'>Claim Now</span></button></a>";
        }
