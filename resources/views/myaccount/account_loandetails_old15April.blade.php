                             ...
                             @if($loan_dully!="[]")
                                <div class="post-content">
                                    <div class="d-flex flex-wrap">
                                          ...
                                          <div class="job-location me-lg-3 me-2"><h6>Duly filled Application Form with Photograph :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6><br>
                                            </div>
                               ...
                               <div class="post-content">
                                ...
                                <?php 
                                    $loan_edu=$loan_doc->where('name','education_proof')->where('loan_id',$loan_doc->loan_id)->get();
                                    // echo $loan_dully;die;
                                ?>
                                @if($count==1)
                                @if($loan_edu!="[]")
