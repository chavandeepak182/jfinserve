                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="stepper-widget mt-sm-5 px-3 px-sm-0">
                            <ul>
                                <li class="active mt-0"><a href="{{config('app.baseURL')}}/">
                                        <div class="number"><i class="icon_check"></i> <span>1</span></div> Loan
                                        Details
                                    </a>
                                </li>
                                <li class=""><a href="{{config('app.baseURL')}}/">
                    ...
                    <div class="col-lg-9">
                        <div class="loan-details-widget bg_white">
                            <form method="POST" action="{{config('app.baseURL')}}/loan/postAddFinanceDetail">
                                @csrf
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input id="oAddress" class="form-control" type="text" name="oAddress" required>
                                    </div>
                                    ...
                                    <div class="form-check form-check-inline active me-5">
                                        <input class="form-check-input" type="radio" name="salariedTab" id="salariedTab" checked="" value="salaried" onclick="show2();">
                                    ...
                                    <div class="col-md-6 existing_loan">
                                        <label class="label" for="exist_tenorloan">Tenor of Loan</label>
