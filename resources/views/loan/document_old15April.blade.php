                        ...
                        <div class="controls">
                          <div class="row">
                            <div class="col-lg-4">
                              ...
                              <input type="hidden" name="identity" value="identity" required="">
                  ...
                  <p>Educational Qualification Proof - Latest Degree (for professionals) *</p>
                    ...
                    <div class="form-group">
                      <div class="controls">
                        <div class="row">
                          <div class="col-lg-4">
                            <input type="file" class="form-control"  name="education[]"  onchange="document.getElementById('education').src = window.URL.createObjectURL(this.files[0])" style="padding-top: 10px;" required="">
                                                ...
                                                <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                                                  ...
                                                  <div class="form-group">
                                                    <div class="controls">
                                                      <div class="row">
                                                          <div class="col-lg-4">
                                                        <input type="file" class="form-control"  name="business_certificate[]"  onchange="document.getElementById('business_certificate').src = window.URL.createObjectURL(this.files[0])" style="padding-top: 10px;" required="">
                                                ...
                                                <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                                                  ...
                                                  <div class="form-group">
                                                    <div class="controls">
                                                      <div class="row">
                                                          <div class="col-lg-4">
                                                        <input type="file" class="form-control"  name="tax_return[]"  onchange="document.getElementById('tax_return').src = window.URL.createObjectURL(this.files[0])" style="padding-top: 10px;" required="">
                                                ...
                                                <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                                                  ...
                                                  <div class="form-group">
                                                    <div class="controls">
                                                       <div class="row">
                                                          <div class="col-lg-4">
                                                        <input type="file" class="form-control"  name="bank_statement[]"  onchange="document.getElementById('bank_statement').src = window.URL.createObjectURL(this.files[0])" style="padding-top: 10px;" accept=".pdf" required="">
                                                ...
                                                <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                                                  ...
                                                  <div class="form-group">
                                                    <div class="controls">
                                                        <div class="row">
                                                          <div class="col-lg-4">
                                                            <input type="file" class="form-control"  name="ageproof[]"  onchange="document.getElementById('ageproof1').src = window.URL.createObjectURL(this.files[0])" style="padding-top: 10px;" required="">
                                                ...
                                                <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                                                  ...
                                                  <div class="form-group" id="">
                                                    <div class="controls">
                                                        <div class="row">
                                                          <div class="col-lg-4">
                                                        <input type="file" class="form-control"  name="resident_proof[]"  onchange="document.getElementById('resident_proof').src = window.URL.createObjectURL(this.files[0])" style="padding-top: 10px;" required="">
                                                ...
                                                <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                                                  ...
                                                  <div class="form-group">
                                                    <div class="controls">
                                                      <div class="row">
                                                          <div class="col-lg-4">
                                                        <input type="file" class="form-control"  name="education[]"  onchange="document.getElementById('education1').src = window.URL.createObjectURL(this.files[0])" style="padding-top: 10px;" required="">
                                                        <input type="hidden" name="education_proof" value="education_proof">
                                                        @if ($errors->has('education'))
                                                        <span class="help-block">
                                                          <strong>{{ $errors->first('education') }}</strong>
                                                      </span>
                                                ...
                                                <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                                                  ...
                                                  <div class="form-group">
                                                    <div class="controls">
                                                        <div class="row">
                                                          <div class="col-lg-4">
                                                        <input type="file" class="form-control"  name="salary_slip[]"  onchange="document.getElementById('salary_slip').src = window.URL.createObjectURL(this.files[0])" style="padding-top: 10px;" required="">
                                                ...
                                                <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                                                  ...
                                                  <div class="form-group">
                                                    <div class="controls">
                                                        <div class="row">
                                                          <div class="col-lg-4">
                                                        <input type="file" class="form-control"  name="form_sixteen[]"  onchange="document.getElementById('form_sixteen').src = window.URL.createObjectURL(this.files[0])" style="padding-top: 10px;" required="">
                                                ...
                                                <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                                                  ...
                                                  <div class="form-group">
                                                    <div class="controls">
                                                      <div class="row">
                                                          <div class="col-lg-4">
                                                        <input type="file" class="form-control"  name="bank_statement[]"  onchange="document.getElementById('bank_statement1').src = window.URL.createObjectURL(this.files[0])" style="padding-top: 10px;" accept=".pdf" required="">
                                                        <input type="hidden" name="bankstatement_proof" value="bankstatement_proof">
                                                        @if ($errors->has('bank_statement'))
                                                        <span class="help-block">
                                                          <strong>{{ $errors->first('bank_statement') }}</strong>
