                            ...
                            <form method="POST" action="{{config('app.baseURL')}}/loan/postAddPersonalDetail">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="experience" class="form-control" type="text" name="experience" required>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="inputPhoneNumber" class="form-control w-100" type="text" name="inputPhoneNumber" maxlength="10" pattern="\d{10}" title="Please enter exactly 10 digits" onkeypress="return isNumberKey(event)" required>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="date_of_birth" id="date_of_birth" class="form-control w-100" placeholder="Enter DOB" required>
                                        <!--
