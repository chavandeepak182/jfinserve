                            ...
                            <form method="POST" action="{{config('app.baseURL')}}/loan/postAddPersonalDetail">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input id='fName' name="fName" value="{{$user->name}}" class="form-control" type="text" required>
                                    </div>

                                    <div class="col-md-12">
                                        <label class="label" for="rAddress">Residence Address*</label>
                                        <input id="rAddress" class="form-control" value="{{$user->present_address}}" type="text" name="rAddress" required>
                                    </div>

                                    <div class="col-md-12 business hidden">
                                        <label class="label" for="oAddress">Office Address*</label>
                                        <input id="oAddress" class="form-control" value="{{$user->company_address}}" type="text" name="oAddress">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="label" for="fcname">Firm/Company Name*</label>
                                        <input id="fcname" class="form-control" value="{{$user->company_name}}" type="text" name="fcname" required>
                                    </div>

                                    <div class="col-md-6">
                                        <label class="label" for="experience">Total Work Experience*</label>
                                        <input id="experience" class="form-control" value="{{$user->work_exp}}" type="text" name="experience" required>
                                    </div>

                                    <div class="col-md-6 business hidden">
                                        <label class="label" for="bedate">Business Establishment Date*</label>
                                        <input id="bedate" class="form-control" value="{{$user->business_establishment_date}}" type="date" name="bedate">
                                    </div>


                                    <div class="col-md-6">
                                        <label class="label" for="nature_work">Nature of business / work*</label>
                                        <input id='nature_work' name="nature_work" value="{{$user->nature_of_work}}" class="form-control" type="text" required>
                                    </div>

                                    <div class="col-md-6">
                                        <label class="label" for="qualification">Highest Qualification*</label>
                                        <input id='qualification' name="qualification" value="{{$user->highest_qualification}}" class="form-control" type="text" required>
                                    </div>

                                    <div class="col-md-6">
                                        <label class="label" for="inputPhoneNumber">Mobile Number*</label>
                                        <input id="inputPhoneNumber" class="form-control w-100" value="{{$user->contact_number}}" type="text" name="inputPhoneNumber" maxlength="10" pattern="\d{10}" title="Please enter exactly 10 digits" onkeypress="return isNumberKey(event)" required>
                                    </div>
                                    ...
                                    <div class="col-md-12 working">
                                        ...
                                        <div class="col-md-3">
                                        <input id="mone_nsalary" class="form-control w-100 @error('mone_nsalary') is-invalid @enderror" type="number" name="mone_nsalary" >
                                        @error('mone_nsalary')
                                        ...
                                        <div class="col-md-3">
                                        <input id="mone_gsalary" class="form-control w-100 @error('mone_gsalary') is-invalid @enderror" type="number" name="mone_gsalary" >
                                        @error('mone_gsalary')
                                          <span class="invalid-feedback" role="alert">
                                            <strong>This Field is required</strong>
                                          </span>
                                    ...
                                    <div class="col-md-12 working">
                                        ...
                                        <div class="col-md-3">
                                        <input id="mtwo_nsalary" class="form-control w-100 @error('mtwo_nsalary') is-invalid @enderror" type="number" name="mtwo_nsalary" >
                                        @error('mtwo_nsalary')
                                          <span class="invalid-feedback" role="alert">
                                            <strong>This Field is required</strong>
                                          </span>
                                        ...
                                        <div class="col-md-3">
                                        <input id="mtwo_gsalary" class="form-control w-100 @error('mtwo_gsalary') is-invalid @enderror" type="number" name="mtwo_gsalary" >
                                        @error('mtwo_gsalary')
                                          <span class="invalid-feedback" role="alert">
                                            <strong>This Field is required</strong>
                                          </span>
                                    ...
                                    <div class="col-md-12 working">
                                        ...
                                        <div class="col-md-3">
                                        <input id="mthree_nsalary" class="form-control w-100 @error('mthree_nsalary') is-invalid @enderror" type="number" name="mthree_nsalary" >
                                        @error('mthree_nsalary')
                                          <span class="invalid-feedback" role="alert">
                                            <strong>This Field is required</strong>
                                          </span>
                                        @enderror
                                        ...
                                        <div class="col-md-3">
                                        <input id="mthree_gsalary" class="form-control w-100 @error('mthree_gsalary') is-invalid @enderror" type="number" name="mthree_gsalary" >
                                        @error('mthree_gsalary')
                                          <span class="invalid-feedback" role="alert">
                                            <strong>This Field is required</strong>
                                          </span>
                                        @enderror
                                    ...
                                    <div class="col-md-12 business hidden">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                            <input id="yone_nprofit" class="form-control w-100 @error('yone_nprofit') is-invalid @enderror" type="number" name="yone_nprofit">
                                            @error('yone_nprofit')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            ...
                                            <div class="col-md-3">
                                            <input id="yone_depreciation" class="form-control w-100 @error('yone_depreciation') is-invalid @enderror" type="number" name="yone_depreciation">
                                            @error('yone_depreciation')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            @enderror
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-3">
                                            <input id="yone_interestloan" class="form-control w-100 @error('yone_interestloan') is-invalid @enderror" type="text" name="yone_interestloan">
                                            @error('yone_interestloan')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            @enderror
                                            ...
                                            <div class="col-md-3">
                                            <input id="yone_grossprofit" class="form-control w-100 @error('yone_grossprofit') is-invalid @enderror" type="number" name="yone_grossprofit">
                                            @error('yone_grossprofit')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            @enderror
                                        ...
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-3">
                                            <input id="yone_totalsales" class="form-control w-100 @error('yone_totalsales') is-invalid @enderror" type="number" name="yone_totalsales" >
                                            @error('yone_totalsales')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            @enderror
                                    ...
                                    <div class="col-md-12 business hidden">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                            <input id="ytwo_nprofit" class="form-control w-100 @error('ytwo_nprofit') is-invalid @enderror" type="number" name="ytwo_nprofit" >
                                            @error('ytwo_nprofit')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            ...
                                            <div class="col-md-3">
                                            <input id="ytwo_depreciation" class="form-control w-100 @error('ytwo_depreciation') is-invalid @enderror" type="number" name="ytwo_depreciation" >
                                            @error('ytwo_depreciation')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            @enderror
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-3">
                                            <input id="ytwo_interestloan" class="form-control w-100 @error('ytwo_interestloan') is-invalid @enderror" type="text" name="ytwo_interestloan" >
                                            @error('ytwo_interestloan')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            @enderror
                                            ...
                                            <div class="col-md-3">
                                            <input id="ytwo_grossprofit" class="form-control w-100 @error('ytwo_grossprofit') is-invalid @enderror" type="number" name="ytwo_grossprofit" >
                                            @error('ytwo_grossprofit')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            @enderror
                                        ...
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-3">
                                            <input id="ytwo_totalsales" class="form-control w-100 @error('ytwo_totalsales') is-invalid @enderror" type="number" name="ytwo_totalsales" >
                                            @error('ytwo_totalsales')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            @enderror
                                    ...
                                    <div class="col-md-12 business hidden">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                            <input id="ythree_nprofit" class="form-control w-100 @error('ythree_nprofit') is-invalid @enderror" type="number" name="ythree_nprofit" >
                                            @error('ythree_nprofit')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            @enderror
                                            ...
                                            <div class="col-md-3">
                                            <input id="ythree_depreciation" class="form-control w-100 @error('ythree_depreciation') is-invalid @enderror" type="number" name="ythree_depreciation" >
                                            @error('ythree_depreciation')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            @enderror
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-3">
                                            <input id="ythree_interestloan" class="form-control w-100 @error('ythree_interestloan') is-invalid @enderror" type="text" name="ythree_interestloan">
                                            @error('ythree_interestloan')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            @enderror
                                            ...
                                            <div class="col-md-3">
                                            <input id="ythree_grossprofit" class="form-control w-100 @error('ythree_grossprofit') is-invalid @enderror" type="number" name="ythree_grossprofit" >
                                            @error('ythree_grossprofit')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            @enderror
                                        ...
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-3">
                                            <input id="ythree_totalsales" class="form-control w-100 @error('ythree_totalsales') is-invalid @enderror" type="number" name="ythree_totalsales" >
                                            @error('ythree_totalsales')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>This Field is required</strong>
                                              </span>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" type="email" id='emailName' value="{{$user->email}}" name="emailName"                         placeholder="examplename@example.com" required>
                                    </div>

                                    <div class="col-md-6">
                                        <label class="label" for="stateName">State*</label>
                                        <input id="stateName" class="form-control" type="text" value="{{$user->state}}" name="stateName" required>
                                    </div>

                                    <div class="col-md-6">
                                        <label class="label" for="cityName">City*</label>
                                        <input id="cityName" class="form-control" type="text" value="{{$user->city}}" name="cityName" required>
                                    </div>

                                    <div class="col-md-6">
                                        <label class="label" for="zipCode">Postal / Zip Code*</label>
                                        <input id="zipCode" class="form-control" type="number" value="{{$user->pincode}}" name="zipCode" required>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="job_business_profile" value="{{$user->job_business_profile}}" class="form-control" type="text" name="job_business_profile">
                                    </div>
                                    <div class="col-md-6">
                                                    ...
                                                    <datalist id="search_contacts">
                                                        @if($users!="[]")
                                                            @foreach($users as $newuser)
                                                                <option value="{{$newuser->contact_number}}">
                                                            @endforeach
                                                        @endif
                                                    </datalist><br>
                                    ...
                                    <input type="hidden" name="channel_partner_id" value="{{$user_id}}">
                                    <input type="hidden" name="assigned_to" value="{{$user_id}}">
                                    @endif
                                    @endauth
                                </div>
                                ...
                                <div class="row mt-60">
                                    <div class="col-md-12">
                                        <div class="nav-btn d-flex flex-wrap justify-content-between">
                                            <a href="{{config('app.baseURL')}}/apply-now?loan_id={{$loan_id}}"
