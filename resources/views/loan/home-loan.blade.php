            ...
            <div class="row box">
                <div class="col-md-6 col-lg-4 mb-3 mb-md-4 d-flex">
                    <div class="card hover-box-shadow">
                        <a href="{{config('app.baseURL')}}/home-loan" class="d-block rounded-top">
                            <img class="card-img-top hover-fade-out img-img" src="{{config('app.baseURL')}}/images/house.jpg" alt="Edutech chatbot">
                        </a>
                        <div class="card-body">
                             <a href="{{config('app.baseURL')}}/home-loan"> 
                                ...
                                <a href="{{config('app.baseURL')}}/home-loan" class="theme-btn mt-3">Apply Now <i class="arrow_right"></i></a>
                             </a> 
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-3 mb-md-4 d-flex">
                    <div class="card hover-box-shadow">
                        <a href="{{config('app.baseURL')}}/contract-loan" class="d-block rounded-top">
                            <img class="card-img-top hover-fade-out img-img" src="{{config('app.baseURL')}}/images/mortage.jpg" alt="Edutech chatbot">
                        </a>
                        <div class="card-body">
                            <a href="{{config('app.baseURL')}}/contract-loan"> 
                                ...
                                <a href="{{config('app.baseURL')}}/contract-loan" class="theme-btn mt-3">Apply Now <i class="arrow_right"></i></a>
                            </a> 
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-3 mb-md-4 d-flex">
                    <div class="card hover-box-shadow">
                        <a href="{{config('app.baseURL')}}/project-loan" class="d-block rounded-top">
                            <img class="card-img-top hover-fade-out img-img" src="{{config('app.baseURL')}}/images/project-loan.jpg" alt="Edutech chatbot">
                        </a>
                        <div class="card-body">
                            <a href="{{config('app.baseURL')}}/project-loan">
                                ...
                                <a href="{{config('app.baseURL')}}/project-loan" class="theme-btn mt-3">Apply Now <i class="arrow_right"></i></a>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-3 mb-md-4 d-flex">
                    <div class="card hover-box-shadow">
                        <a href="{{config('app.baseURL')}}/overdraft-facility" class="d-block rounded-top">
                            <img class="card-img-top hover-fade-out img-img" src="{{config('app.baseURL')}}/images/od-loan.jpg" alt="Edutech chatbot">
                        </a>
                        <div class="card-body">
                            <a href="{{config('app.baseURL')}}/overdraft-facility">
                                ...
                                <a href="{{config('app.baseURL')}}/overdraft-facility" class="theme-btn mt-3">Apply Now <i class="arrow_right"></i></a>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-3 mb-md-4 d-flex">
                    <div class="card hover-box-shadow">
                        <a href="{{config('app.baseURL')}}/lease-rental-discounting" class="d-block rounded-top">
                            <img class="card-img-top hover-fade-out img-img" src="{{config('app.baseURL')}}/images/capital.jpg" alt="Edutech chatbot">
                        </a>
                        <div class="card-body">
                            <a href="{{config('app.baseURL')}}/lease-rental-discounting">
                                ...
                                <a href="{{config('app.baseURL')}}/lease-rental-discounting" class="theme-btn mt-3">Apply Now <i class="arrow_right"></i></a>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card hover-box-shadow">
                        ...
                        <div class="card-body">
                            <a href="{{config('app.baseURL')}}/msme-loan">
                                ...
                                <a href="{{config('app.baseURL')}}/msme-loan" class="theme-btn mt-3">Apply Now <i class="arrow_right"></i></a>
                            </a>
                        </div>
                    </div>
                </div>
