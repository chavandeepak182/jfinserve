                ...
                <div class="row gx-0 pt-45 ">
                    ...
                    <div class="col-lg-4 col-sm-6 text-center text-sm-start ms-0 ">
                        <div class="footer-widget wow fadeInLeft mb-30">
                            <div class="footer-text mb-20">
                                <p>Finance is a leading bank in the worldzone and a prominent indian banking</p>
                            </div>

                            <span class="overline">Loan Approved Till & Approved Rate</span>

                            <div class="footer-bold">
                                <span class="counter">₹<span>3203040</span> </span>
                                <span class="counter">-<span>80</span>% </span>
                            </div>
                            <p class="time">2021-01-05 14:00 </p>
                        </div>
                    </div>
                        ...
                        <div class="footer-widget mb-30 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="footer-link">
                                <ul>
                                    ...
                                    <li><a href="{{config('app.baseURL')}}/refer-earn"> Refer & Earn</a></li>
                    ...
                    <div class="col-lg-2 col-sm-6 text-center text-sm-start me-0 ms-lg-5">
                        <div class="footer-widget mb-30 wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <div class="footer-link">
                                <ul>
                                    <li><a href="{{config('app.baseURL')}}/loans/home-loan">Home Loan</a></li>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3 text-center text-lg-start">
                        <a href="index.html" class="p-0 m-0"><img src="{{config('app.baseURL')}}/assets/img/logo/Logo.png" alt="logo"></a>
                    </div>
                    <div class="col-lg-5 text-center my-3 my-sm-0">
                        <div class="copyright-text">
                            <p>Copyright&copy; Finance 2021. <br class="d-sm-none"> <a class="ms-2" href="#">Privecy</a> |
