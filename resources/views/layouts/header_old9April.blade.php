                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="header-info-right">
                            ...
                            <li>
                              @auth
                                  <a class="loginbtn">Logged In As <?php echo Auth::user()->name; ?></a>
                              @else
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav menu ms-auto">
                            <li class="nav-item ">
                             ...
                             <li class="nav-item ">
                                <a href="about-us" class="nav-link dropdown-toggle" role="button"
                                    >About Us</a>
                                <i class="arrow_carrot-down_alt2 mobile_dropdown_icon" aria-hidden="true"
                                    data-bs-toggle="dropdown"></i>
                            ...
                            <li class="nav-item ">
                                <a href="loans/home-loan" class="nav-link dropdown-toggle" role="button"
                                    >Services</a>
                                <i class="arrow_carrot-down_alt2 mobile_dropdown_icon" aria-hidden="true"
                                    data-bs-toggle="dropdown"></i>
                            ...
                            <li class="nav-item ">
                                <a href="refer-earn" class="nav-link dropdown-toggle" role="button">Referal Program</a>
                                <i class="arrow_carrot-down_alt2 mobile_dropdown_icon" aria-hidden="true"
                                    data-bs-toggle="dropdown"></i>
                               
                            </li>
                            <li class="nav-item ">
                                <a href="properties" class="nav-link dropdown-toggle" role="button"
                                    >Properties</a>
                                <i class="arrow_carrot-down_alt2 mobile_dropdown_icon" aria-hidden="true"
                                    data-bs-toggle="dropdown"></i>
                            ...
                            <li class="nav-item ">
                                <a href="contact" class="nav-link dropdown-toggle" role="button"
                                    >Contact Us</a>
                                <i class="arrow_carrot-down_alt2 mobile_dropdown_icon" aria-hidden="true"
                                    data-bs-toggle="dropdown"></i>
