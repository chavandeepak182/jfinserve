            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3 text-center text-lg-start">
                        <a href="{{config('app.baseURL')}}" class="p-0 m-0"><img src="{{config('app.baseURL')}}/images/logo/logo.png" alt="logo" style="width:200px;"></a>
                    </div>
                     <div class="col-lg-5 text-center my-3 my-sm-0">
                        <div class="copyright-text">
                            <p>Copyright&copy; Jfinserv Consultant India Private Limited 2022. <br class="d-sm-none"> <a class="ms-2" href="{{config('app.baseURL')}}/privacy-policy">Privacy Policy</a> |
                                <a class="ms-0" href="{{config('app.baseURL')}}/terms-condition">Term of
                                    Services</a> |
                                <a class="ms-0" href="{{config('app.baseURL')}}/cookie-policy"> Cookie Policy</a>
                            </p>
                        </div>
                    </div>
