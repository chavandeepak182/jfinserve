                ...
                <div class="row gx-0 pt-45 ">
                        ...
                        <div class="footer-widget mb-30 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="footer-link">
                                <ul>
                                    ...
                                    <li><a href="{{config('app.baseURL')}}/referral-program">Referral Program</a></li>
                                    <li><a href="{{config('app.baseURL')}}/properties"> Properties</a></li>
                                    <li><a href="{{config('app.baseURL')}}/services#HomeLoanCalculator">EMI Calculator</a></li>
                    ...
                    <div class="col-md-2 text-center text-sm-start me-0">
                        <div class="footer-widget mb-30 wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <div class="footer-link">
                                <ul>
                                    <li><a href="{{config('app.baseURL')}}/home-loan">Home Loan</a></li>
                                    <li><a href="{{config('app.baseURL')}}/contract-loan">Contract Loan</a></li>
                                    <li><a href="{{config('app.baseURL')}}/project-loan">Project Loan</a></li>
                                    <li><a href="{{config('app.baseURL')}}/overdraft-facility">Overdraft Facility</a></li>
                                    <li><a href="{{config('app.baseURL')}}/lease-rental-discounting">Lease Rental Discounting</a></li>
                                    <li><a href="{{config('app.baseURL')}}/msme-loan">MSME Loan</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 text-center text-sm-start">
                        <div class="footer-widget mb-30 wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <div class="footer-link">
                                <ul>
                                    <li><a href="{{config('app.baseURL')}}/apply-now"> Apply Now</a></li>
                                    <li><a href="{{config('app.baseURL')}}/myprofile"> Profile</a></li>
                                    <li><a href="{{config('app.baseURL')}}/myprofile">Track Application</a></li>
                    ...
                    <div class="col-md-2 text-center text-sm-start me-0">
                        <div class="footer-widget mb-30 wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <div class="footer-link">
                                <ul>
                                    <li><a href="{{config('app.baseURL')}}/referral-program#referFriend">Refer Your Friend</a></li>
                                    <li><a href="{{config('app.baseURL')}}#banking-partners">Banking Partners</a></li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-center">
                        <div class="copyright-text">
                            <p><a class="ms-2" href="{{config('app.baseURL')}}/privacy-policy">Privacy Policy</a> | <a class="ms-0" href="{{config('app.baseURL')}}/terms-condition">Term of
                                    Service</a> | <a class="ms-0" href="{{config('app.baseURL')}}/cookie-policy"> Cookie Policy</a>
                            </p>
                        </div>
                    </div>
