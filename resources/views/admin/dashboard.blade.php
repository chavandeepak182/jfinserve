...
@endphp
                        ...
                        <div class="card-content">
                          <div class="card-body text-center">
                            ...
                            <div class="text-center">
                              <h1 class="mb-2 text-white">Welcome {{$name}},</h1>
          ...
          <div class="col-lg-4 col-md-4 col-12 d-flex">
            <div class="card" style="width:100%;">
              <div class="card-header d-flex flex-column align-items-start pb-0">
                  ...
                  <h2 class="text-bold-700 mt-1 mb-25">{{$user_count}}</h2>
      ...
      <div class="col-lg-4 col-md-4 col-12 d-flex">
       ...
       <div class="card" style="width:100%;">
          ...
          <div class="card-content">
           ...
           <div class="col-md-12">
        <p>No. of Loan Applications : <b>{{$total_loan_applied_for_count}}</b></p>
        <p>No. of Approved Applications: <b style="color:#4BB543;">{{$loan_approved_count}}</b></p>
        <p>No. of Rejected Applications  : <b style="color:#E01E12;">{{$loan_rejected_count}}</b></p>
      ...
      <div class="card" style="width:100%;">
        ...
        <div class="card-content">
         ...
         <div class="col-md-12">
        <p>Total Loan Amount : <b>₹ {{$total_loan_applied_for}}</b></p>
        <p>Total Loan Amount Approved: <b style="color:#4BB543;">₹ {{$loan_approved}} ({{$amount_loan_approved_percentage}}%)</b></p>
        <p>Total Loan Amount Rejected : <b style="color:#E01E12;">₹ {{$loan_rejected}} ({{$amount_loan_rejected_percentage}}%)</b></p>
...
showchart(["{{$loan_approved_percentage}}","{{$loan_rejected_percentage}}"]);
...
$('#simple-pie-chart').remove(); 
  ...
  $(document).ready(function() {
      var barvalue=["{{$total_loan_applied_for}}","{{$loan_approved}}","{{$loan_rejected}}"];
      
      barchatchart(["{{$total_loan_applied_for}}","{{$loan_approved}}","{{$loan_rejected}}"]);
...
<script src="{{config('app.baseURL')}}\assets\js\chart.min.js?id=b235b564de9c2c1d61d7"></script>
<script src="https://cdn.jsdelivr.net/npm/chartjs-plugin-datalabels@0.7.0"></script>
<script src="{{config('app.baseURL')}}/vendors\js\charts\apexcharts.min.js?id=bbb1adadc937c1636f35"></script>
 <!--<script src="{{config('app.baseURL')}}/js\scripts\charts\chart-apex.js?id=ee908d18bbd8fe26f41d"></script>-->
@endsection