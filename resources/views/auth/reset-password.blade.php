...
<!--  <div class="col-lg-6"style="background:url(https://jfinserv.com/assets/img/banner/loginimg.png) no-repeat fixed;">
   ...
   <div class="login_leftbox col-lg-6 col-md-6 col-sm-12 col-12 mobile-view-top" style="background:url({{config('app.baseURL')}}/assets/img/banner/grc-bg-6b2fea043861dedae0e18db7c192ea80fdee6a660dce540c9919d32480891d14.svg) no-repeat fixed;">
...
<!-- <div class="container"> -->
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
               <h1 class="h2 text-left" style="margin-left:4%;margin-top:4%;"><b>Change Password</b></h1>

                <div class="card-body">
                    <form method="POST" action="{{config('app.baseURL')}}/change-forgot-password">
                        @csrf
 ...
 <div class="input-group show_hide_password" id="show_hide_password">
        ...
        <a href="javascript:void(0);"><i class="fa fa-eye-slash" aria-hidden="true" style="padding-right:10px;"></i></a>
              ...
              <input id="password-confirm" type="password" class="form-control form-control-password" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm Password">
              <div class="input-group-addon">
        <a href="javascript:void(0);"><i class="fa fa-eye-slash" aria-hidden="true" style="padding-right:10px;"></i></a>
        </div>
      </div>
