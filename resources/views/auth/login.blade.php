      ...
      <div class="row justify-content-center my-1">
        ...
        <a href="javascript:void(0);"><i class="fa fa-eye-slash" aria-hidden="true" style="padding-right:10px;"></i></a>
            ...
            @enderror
                ...
                <a href="{{config('app.baseURL')}}/forgot_password"> Forgot Password?</a><br>
        ...
        <div class="col-md-12 m-20 mt-2">
          ...
          <p class="psign">Register As a Partner <a href="{{config('app.baseURL')}}/Auth/registerpartner" style="color:blue"> Register</a></p>
          </div>
        </div>
        </div>
    </div>
