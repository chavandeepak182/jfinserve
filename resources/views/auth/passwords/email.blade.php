      ...
      <div class="row justify-content-center my-1">
          <div class="col-lg-8 col-md-12">
            ...
            <div class="card card-body shadow text-left text-dark" style="border-radius: 10px;">
                <!--<img src="{{config('app.baseURL')}}/images/logo/logo.png" srcset="{{config('app.baseURL')}}/images/logo/logo.png" alt="logo" style="width:200px;">-->
                <br>
               <h1 class="h2 text-left mb-lg-5"><b>Forgot Password</b></h1>
              <form method="POST" action="{{config('app.baseURL')}}/passwordreset">
                @csrf
                <div class="form-group" >
                   <input id="number" type="number" placeholder="Contact Number" class="form-control @error('contact_number') is-invalid @enderror" name="contact_number" value="{{ old('contact_number') }}" required autocomplete="contact_number" autofocus>
                ...
                <!-- <input type="checkbox"> By clicking Agree & Join, you agree to the Register User Agreement, Privacy Policy, and Cookie Policy.</label><br><br> -->
                 ...
                 <br><button class="btn btn-primary btn-lg" type="submit" style="width: 100%;">Reset Password</button>
