...
<section class="row no-gutters p-0 bg-light min-vh-100" >
  <!--<div class="col-lg-6 col-md-6 col-sm-12 col-12" style="background:url({{config('app.baseURL')}}/assets/img/loginimage.png) no-repeat fixed;">-->
...
<form method="POST" action="{{ route('password.email') }}">
      ...
      <div class="welcome_content" style="padding-bottom: 40px;">
        <h3 class="welcome">Forgot Password!</h3>
        ...
        <p class="text-muted"><small>A link will be send to email to reset password</small></p>
      </div>
            

      <div class="floating-form" style="padding: 0px 50px 10px 50px;">
        <div class="floating-label">      
          <input class="form-control floating-input email" name="email" type="text" placeholder="Email" data-parsley-required="true" data-parsley-pattern="^(([^<>()\[\]\\.,;:\s@/&quot;]+(\.[^<>()\[\]\\.,;:\s@/&quot;]+)*)|(/&quot;.+/&quot;))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$" data-parsley-required-message="Please enter the email id" data-parsley-pattern-message="Invalid email" autofocus="" required>
      ...
      <button type="submit" class="btn btn-primary login_user btn-lg" style="margin-top: 10%;">Send Password Reset Link <img src="{{config('app.baseURL')}}/images/right-arrorigharrow.svg" style="padding-left: 5px; height: 13px;"></button>
    </div>
