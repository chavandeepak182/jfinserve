...
<!-- <div class="container"> -->
        ...
        <div class="col-lg-10 col-md-12">
          <div class="card card-body shadow text-left text-dark" style="border-radius: 10px;">
            ...
            <h1 class="h2 text-left"><b>Register As Partner</b></h1>
              <div class="card-body">
                <form method="POST" action="{{config('app.baseURL')}}/newpartnerregister">
                  @csrf
  ...
  <p style="color:#000;margin-left: 20px;">Already registered as a partner? <a href="{{config('app.baseURL')}}/login" style="color:blue;"> Login</a></p><br>
</div>
</div>
</div>
</div>
