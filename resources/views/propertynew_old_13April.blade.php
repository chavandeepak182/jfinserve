							...
							<div class="feat_property">
								...
								<div class="details">
									<div class="tc_content">
										<p class="text-thm"><a href="{{config('app.baseURL')}}/property/{{$get_property->property_id}}">{{$get_property->builder_name}}</a></p>
										<h4><a href="{{config('app.baseURL')}}/property/{{$get_property->property_id}}">{{$get_property->property_name}}</a></h4>
										<p><span class="flaticon-placeholder"></span><a href="{{config('app.baseURL')}}/property/{{$get_property->property_id}}">{{$get_property->location}}</a></p>
