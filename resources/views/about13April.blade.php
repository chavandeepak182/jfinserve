                ...
                <div class="row pt-65 gy-md-0 gy-4">
                    ...
                    <div class="col-lg-3">
                        <div class="single-leadership-widget wow fadeInUp " data-wow-delay="0.3s">
                            <a href="#">
                                <img src="http://jfinserv.com/assets/img/leadership/img-2.png" alt="leader-2">
                                <div class="leader-info">
                                    <h5>Eldridge Robles</h5>
                                    <p>Co-Founder, Conis</p>
                                </div>
                    ...
                    <div class="col-lg-3">
                        <div class="single-leadership-widget wow fadeInUp " data-wow-delay="0.5s">
                            <a href="#">
                                <img src="http://jfinserv.com/assets/img/leadership/img-3.png" alt="leader-3">
                                <div class="leader-info">
                                    <h5>Eldridge Robles</h5>
                                    <p>Co-Founder, Conis</p>
                                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 ">
                        <div class="cta-content mt-3 mt-sm-0 text-sm-end text-center">
                            <a href="https://jfinserv.com/loans/home-loan" class="theme-btn wow fadeInLeft">Explore Now</a>
                        </div>
                    </div>
                </div>
            </div>
